...
hancer.note.prototype = {
	...
	popupMenu : function(noteId, senderName, senderId, isBlocked){
		...
		$('#popupMenu').css('top',this.getAbsTop('send_' + noteId)+ 5);
...
hancer.note.dialog.prototype = {
	...
	process : function() {
		if(this.getValue('modal')){
   		...
   		this.contentPanel = $('<div id="dialogContents" class="dialog-contents" style="padding-top: 5px; padding-left: 5px;"></div>');
