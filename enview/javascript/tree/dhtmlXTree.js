 ...
 if((!dhtmlObject.waitUpdateXML)||(dhtmlObject.waitUpdateXML.toString().search(dhtmlObject.dlmtr+cId+dhtmlObject.dlmtr)!=-1))
{
 ...
 var userAttribute = nodx.getAttribute("userData");
 //alert("userAttribute=" + userAttribute);
 ...
 newNode.htmlNode.setAttribute("userData", userAttribute);
 ...
 if(itemObject.unParsed)
{
 ...
 //if(this.dragFunc)if(!this.dragFunc(itemObject.id,targetObject.id,(beforeNode?beforeNode.id:null),itemObject.treeNod,targetObject.treeNod,this.subKey))return false;
