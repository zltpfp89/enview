...
enview.portal.MessageResource.prototype =
{
	...
	init : function()
	{
		...
		this.messageRes.put("mm.error.invalid.insert.0", "데이터를 추가 할 수 없는 위치입니다.");
		...
		this.messageRes.put("mm.error.sql.problem.0", "데이터 처리중 에러가 발생하였습니다.");
		this.messageRes.put("mm.error.system.failure.0", "시스템 에러가 발생하였습니다 ");
		this.messageRes.put("mm.info.cant.hanguel.0", "한글은 입력할 수 없습니다.");
		this.messageRes.put("mm.info.cant.special.0", "잘못된 문자가 있습니다. 특수문자는 입력할수 없습니다.");
		this.messageRes.put("mm.info.cant.whitespace.0", "공백이 올수 없습니다.");
		this.messageRes.put("mm.info.common.success.0", "정상적으로 처리되었습니다.");
		this.messageRes.put("mm.info.input.0", "입력해 주십시오.");
		this.messageRes.put("mm.info.input.param.0", "{0} 입력해 주세요.");
		...
		this.messageRes.put("mm.info.only.minusNumber.0", "잘못된 숫자가 있습니다. 마이너스, 숫자 이외 문자는 입력할수 없습니다.");
		...
		this.messageRes.put("mm.info.select.0", "{0| 선택해 주십시오.");
		this.messageRes.put("mm.info.select.multi.0", "{0} {1}개 선택해주십시오");
