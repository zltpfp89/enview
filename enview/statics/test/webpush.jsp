...
<!-- 	
  ...
  var webPushPublicKey = '<%=Enview.getConfiguration().getString("webpush.publicKey", "BOWHgE-JLePrESKxmwoC-d77pkBQHk62WVwS4qgJyjKXf6CV3O5owh7rbyeDmQrLTeyJtjZYK3RPZ7Y-K6gIiD8" )%>';
  </script>
</head>
