						...
						<div id="PrincipalPermissionManager_DetailTabPage">
							<div class="webformpanel" style="width:100%;">
								...
								<tr>
									<td align="right">
										<%--  
										<a href="javascript:aPrincipalPermissionManager.doCreate()" class="btn_B"><span><util:message key='ev.title.new'/></span></a>
										 --%>
										<a href="javascript:aPrincipalPermissionManager.doUpdate(true)" class="btn_B"><span><util:message key='ev.title.save'/></span></a>
									</td>
								</tr>
								</table>
								</form>
