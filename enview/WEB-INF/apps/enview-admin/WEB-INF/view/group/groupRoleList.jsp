...
<div id="GroupRoleManager_GroupRoleTabPage">
			...
			<thead>
				<tr>
					...
					<th class="C" ch="0" onclick="aGroupRoleManager.doSort(this, 'ROLE_ID');" >
						<span class="table_title"><util:message key='ev.prop.securityGroupRole.roleId'/></span>
					</th>	
					<th class="C" ch="0">
	...
	<div id="GroupRoleManager_EditFormPanel" class="board"  style="display:none; ">
			...
			<div id="GroupRoleManager_DetailTabPage">
				<form id="GroupRoleManager_EditForm" style="display:inline" action="" method="post">
					...
					<table id="grid-table" cellpadding="0" cellspacing="0" summary="게시판" class="table_board">
						...
						<tr>
							<th class="L"><util:message key='ev.prop.securityGroupRole.roleId'/></td>
							<td class="L">
