							...
							<caption>게시판</caption>
								...
								<tr>
									...
									<td colspan="3" class="L">
										<input type="text" id="NoticeManager_title" name="title" value="" maxLength="25" label="<util:message key='ev.prop.notice.title'/>" class="txt_400" />
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td class="L">
										...
										<a href="javascript:aNoticeManager.doRemoveGroup()" class="btn_B">
											<span><util:message key="ev.title.remove"/></span>
										</a>
									</td>
									<th class="L">
										적용페이지
