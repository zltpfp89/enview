...
<form id="receivebox" name="receivebox" method="post" onsubmit="return false;">
	...
	<div class="searchArea">
		<h1 class="title"><util:message key="hn.note.label.recyclebinBox"/></h1>
		<p class="search">
			...
			<input type="text" class="txt_110" id="searchValue" value="<c:out value="${form.searchValue}"/>" onkeyup="enNote.searchRecyclebinNotes(event);"/>
			<a href="javascript:enNote.searchRecyclebinNotes(event);" class="btn_type02"><span><util:message key="hn.note.label.search"/></span></a>
	...
	<!-- 버튼영역 -->
	<div class="btnArea">
		<a href="javascript:enNote.deleteRecyclebinNotes();" class="btn_type01" title="delete"><span><util:message key="hn.note.label.delete"/></span></a>  <a href="javascript:enNote.restoreRecyclebinNotes();" class="btn_type01" title="restore"><span><util:message key="hn.note.label.restore"/></span></a>
		<span class="pageBtn">
	...
	<div class="tableArea">
		...
		<caption>메세지리스트입니다.</caption>
			...
			<c:if test="${empty form.noteFormList}">
				<tr><td colspan="5"><util:message key="hn.note.label.hasNotRecyclebinNote"/></td></tr>
			</c:if>
