...
<div id="scheduleDetails" class="mobile scheduleEdit scheduleDetails<c:if test="${calendar.bilingual && calendar.isPublic }">Public</c:if>">
	...
	<div id="scheduleDetailHeader" class="mobile scheduleDetail<c:if test="${calendar.bilingual && calendar.isPublic }">Public</c:if> header">
	...
	--%>
	<div id="scheduleDetailFooter" class="mobile scheduleDetail<c:if test="${calendar.bilingual && calendar.isPublic }">Public</c:if> footer">
