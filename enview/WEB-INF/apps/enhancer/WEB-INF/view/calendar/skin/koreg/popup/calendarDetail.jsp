...
<div id="calendarDetails" style="width:380px;" class="calendarEdit calendarDetails<c:if test="${calendar.isPublic }">Public</c:if>">
	...
	<div id="calendarDetailHeader" class="calendarDetail<c:if test="${calendar.isPublic }">Public</c:if> header">
	...
	<c:if test="${form.cmd != 'MODIFY' || (!calendar.isPublic && ( calendar.isOwner || fn:indexOf(calendar.permissions, 'U') > -1 || fn:indexOf(calendar.permissions, 'A') > -1 )) }">
