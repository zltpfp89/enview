...
<body>
	<div id="mini_calendar" class="me">
		<div class="me-header">
			<div class="me-header-left"><img id="today_button" class="today" src="<%=request.getContextPath()%>/hancer/images/eventCommon/mng/calendar/btn/btn_today.gif" alt="today" /></div>
		...
		</div><c:out value="${paramMap.SRCH_STD_DATE}"/>
	</div>
</body>
</html>