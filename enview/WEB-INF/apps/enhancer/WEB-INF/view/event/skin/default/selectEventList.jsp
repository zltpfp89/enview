...
<script type="text/javascript">
	...
	function moreNewEvent(n){
		...
		document.getElementById("eventListFrom").action = actPath+"/selectEventList.hanc";
	...
	function viewEvent(evSeq){
		...
		var frm = document.getElementById("eventListFrom");
		frm.action = actPath+"/detailEvent.hanc";
		frm.submit();
	}
		...
		<div id="body">
			<div class="event_Maincontents"> 
				...
				<div class="latestEvent_box">
					...
					<div class="contentIn">
						<div class="page_head"><a href="#link" style="cursor:pointer;" onclick="javascript:changeDateDisp('pre');"><img src="<%=request.getContextPath()%>/hancer/images/eventCommon/mng/btn_prev.gif" alt="이전 달"></a> <strong id="date_disp"></strong> <a href="#link" style="cursor:pointer;" onclick="javascript:changeDateDisp('next');"><img src="<%=request.getContextPath()%>/hancer/images/eventCommon/mng/btn_next.gif" alt="다음 달"></a> <c:if test="${paramMap.LANG_KND == 'ko'}"><span class="btn_dwm"><a href="<%=request.getContextPath()%>/event/selectMainEventList.hanc?HIST_BACK_TYPE=MAIN"><img src="<%=request.getContextPath()%>/hancer/images/eventCommon/mng/event/btn_pre_event.gif"alt="BackHome" /></a> <a href="#link" style="cursor:pointer;" onclick="javascript:srchEvent('D');"><c:if test="${paramMap.SRCH_DATE_DIV=='D'}"><img src="<%=request.getContextPath()%>/hancer/images/eventCommon/mng/event/btn_day_on.gif" alt="일"></c:if><c:if test="${paramMap.SRCH_DATE_DIV!='D'}"><img src="<%=request.getContextPath()%>/hancer/images/eventCommon/mng/event/btn_day.gif" alt="일"></c:if></a> <a href="#link" style="cursor:pointer;" onclick="javascript:srchEvent('W');"><c:if test="${paramMap.SRCH_DATE_DIV=='W'}"><img src="<%=request.getContextPath()%>/hancer/images/eventCommon/mng/event/btn_week_on.gif" alt="주"></c:if><c:if test="${paramMap.SRCH_DATE_DIV!='W'}"><img src="<%=request.getContextPath()%>/hancer/images/eventCommon/mng/event/btn_week.gif" alt="주"></c:if></a> <a href="#link" style="cursor:pointer;" onclick="javascript:srchEvent('M');"><c:if test="${paramMap.SRCH_DATE_DIV=='M'}"><img src="<%=request.getContextPath()%>/hancer/images/eventCommon/mng/event/btn_month_on.gif" alt="월"></c:if><c:if test="${paramMap.SRCH_DATE_DIV!='M'}"><img src="<%=request.getContextPath()%>/hancer/images/eventCommon/mng/event/btn_month.gif" alt="월"></c:if></a></span></c:if><c:if test="${paramMap.LANG_KND == 'en'}"><span class="btn_dwm"><a href="<%=request.getContextPath()%>/event/selectMainEventList.hanc?HIST_BACK_TYPE=MAIN"><img src="<%=request.getContextPath()%>/hancer/images/eventCommon/mng/event/btn_pre_event.gif"alt="BackHome" /></a> <a href="#link" style="cursor:pointer;" onclick="javascript:srchEvent('D');"><c:if test="${paramMap.SRCH_DATE_DIV=='D'}"><img src="<%=request.getContextPath()%>/hancer/images/eventCommon/mng/event/btn_day_on_en.gif" alt="day"></c:if><c:if test="${paramMap.SRCH_DATE_DIV!='D'}"><img src="<%=request.getContextPath()%>/hancer/images/eventCommon/mng/event/btn_day_en.gif" alt="day"></c:if></a> <a href="#link" style="cursor:pointer;" onclick="javascript:srchEvent('W');"><c:if test="${paramMap.SRCH_DATE_DIV=='W'}"><img src="<%=request.getContextPath()%>/hancer/images/eventCommon/mng/event/btn_week_on_en.gif" alt="week"></c:if><c:if test="${paramMap.SRCH_DATE_DIV!='W'}"><img src="<%=request.getContextPath()%>/hancer/images/eventCommon/mng/event/btn_week_en.gif" alt="week"></c:if></a> <a href="#link" style="cursor:pointer;" onclick="javascript:srchEvent('M');"><c:if test="${paramMap.SRCH_DATE_DIV=='M'}"><img src="<%=request.getContextPath()%>/hancer/images/eventCommon/mng/event/btn_month_on_en.gif" alt="month"></c:if><c:if test="${paramMap.SRCH_DATE_DIV!='M'}"><img src="<%=request.getContextPath()%>/hancer/images/eventCommon/mng/event/btn_month_en.gif" alt="month"></c:if></a></span></c:if></div>
						<!-- eventList -->
			...
			<div class="event_Sidebar">
				<div class="event_Sidebarbox first">
					...
					<div class="btn_eventadd"><span class="btn_event"><a href="<%=request.getContextPath()%>/event/insertEventByUser.hanc?mngMode=WRITE"><%=msgs.getString("ev.hnevent.label.addEvent")%></a></span>&nbsp;<span class="btn_event"><a href="<%=request.getContextPath()%>/portal<c:out value="${paramMap.SITE_NAME}"/>/academicCalendar/myEventList.page" target="_parent"><%=msgs.getString("ev.hnevent.label.myevent")%></a></span></div>
				</div>
				<div class="event_Sidebarbox">
					<div id="eventCalendar">
						<iframe src="<%=request.getContextPath()%>/event/selectEventCalendar.hanc?baseDate=<c:out value='${paramMap.SRCH_STD_DATE}'/>" width="210px" height="175px" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" title="calendar"></iframe>
					</div>
				</div>
				<!-- category -->
