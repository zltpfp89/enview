...
<!-- board -->
<div id="CalendarManager_UserTabPage" class="board">
	<!-- searchArea-->
	...
	<form id="CalendarManager_ListForm" style="display:inline" name="CalendarManager_ListForm" action="" method="post">
		<table id="grid-table" cellpadding="0" cellspacing="0" summary="게시판" class="table_board">
			...
			<thead>
				<tr>
					<th class="C first">
						<span class="table_title"><input type="checkbox" id="checkAll" name="checkAll" class="calendarCheck" onclick="enCal.checkAll('calendarCheck');"/></span>
					</th>
	...
	<div class="tcontrol">
		<!-- paging -->
		<div id="CalendarManager_ITERATOR" class="paging">
			...
			<a href="javascript:void(0);" class="noline">
				<img src="<%=request.getContextPath() %>/admin/images/btn_last.gif" title="맨 마지막으로" onclick="javascript:enCalDetail.prev10Page();">
			</a>				
		</div>
		<!-- paging//-->
	</div>
	...
	<div class="btnArea">
		<div class="rightArea">
			<a href="javascript:enCalDetail.uiUserCalendarListForm();" class="btn_B"><span><util:message key="ev.title.add"/></span></a>
			<a href="javascript:enCalDetail.deletes();" class="btn_B"><span><util:message key="ev.title.remove"/></span></a>
		</div>
	</div>
	<!-- btnArea//-->	
</div>
