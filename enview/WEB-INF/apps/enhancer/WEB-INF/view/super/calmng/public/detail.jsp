				...
				<td colspan="3" class="L">
					<div class="sel_100">
						<select id="calendarPublicType" name="publicType" class="txt_100">
							<option <c:if test="${calendarpublicType == 'P'}">selected="selected"</c:if> value="P">전체 공개(P)</option>
							<option <c:if test="${calendarpublicType == 'G'}">selected="selected"</c:if> value="G">부서 공개(G)</option>
						</select>
					</div>
				</td>
			</tr>
