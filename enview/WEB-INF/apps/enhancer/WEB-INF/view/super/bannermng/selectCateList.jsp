		...
		<div class="detail">
			...
			<div class="board first">
				...
				<div class="tsearchArea">
					<!--pageTitle -->
					<h1><%=msgs.getString("ev.hnevent.label.bannerCategoryManagement")%></h1>
					<!--pageTitle// -->
					<fieldset>
						<a href="#link" onclick="javascript:addRow();" class="btn_W"><span><%=msgs.getString("ev.hnevent.label.add")%></span></a>
						<a href="#link" onclick="javascript:procMultiData('save');" class="btn_W"><span><%=msgs.getString("ev.hnevent.label.bannerSave")%></span></a>
						<a href="#link" onclick="javascript:procMultiData('delete');" class="btn_W"><span><%=msgs.getString("ev.hnevent.label.delete")%></span></a>
					</fieldset>		
				</div>
				<!-- searchArea// -->
				<form id="cateListForm" name="cateListForm" action="<%=request.getContextPath()%>/hancer/banner/selectCateList.hanc" method="post">
