                    				...
                    				<a href="javascript:mainbanner_direct(${status1.index })" class="page">
                    					<c:choose>
                    						<c:when test="${status1.index == status.index }">
                    							<img id="subimage_<c:out value='${status.index}'/>" src="<%=request.getContextPath() %>/hancer/images/eventCommon/user/fac/li_on.png" alt="${status.count }페이지" />
                    						</c:when>
                    						<c:otherwise>
                    							<img id="subimage_<c:out value='${status.index}'/>" src="<%=request.getContextPath() %>/hancer/images/eventCommon/user/fac/li_off.png" alt="${status.count }페이지" />
                    						</c:otherwise>
                    					</c:choose>
                    				</a>
                    				
								</c:forEach>
									 <a href="javascript:mainbanner_Stopdisplay()" class="page"><img src="<%=request.getContextPath() %>/hancer/images/eventCommon/user/fac/btn_pause.png" alt="일시정지" /></a>
                  					 <a href="javascript:mainbanner_Startdisplay('f')" class="page"><img src="<%=request.getContextPath() %>/hancer/images/eventCommon/user/fac/btn_play.png" alt="시작" /></a>
							</p>
					</div>
			</c:forEach>
		</c:if>
