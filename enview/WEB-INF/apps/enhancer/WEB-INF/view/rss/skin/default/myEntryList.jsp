...
<div class="webpanel">
	<div id="RssManager">
		<div>
			<table width="99%">
				<tr>
					<td align="right">[<c:out value="${form.serviceType }"/>]
						<select id="entryCategoryList" name="categoryList" onchange="javascript:enEntry.search();">
						...
						<select id="entryListCount" name="listCount" onchange="javascript:enEntry.search();">
