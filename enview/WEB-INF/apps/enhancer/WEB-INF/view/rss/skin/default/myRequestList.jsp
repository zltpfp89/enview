			...
			<div style=" " class="webpanel">
				<div id="UserManager_UserTabPage">
					  ...
					  <table id="grid-table" width="100%" border="0" cellspacing="0" cellpadding="0">
						<thead>
							...
							<tr style="cursor: pointer;">
								...
								<th class="webgridheader"><span ><util:message key="hn.rss.label.isAllowed"/></span></th>
							</tr>
						</thead>
						...
						<c:forEach items="${feedList}" var="feed"  varStatus="idx">
							<tr style="cursor:pointer;" class="<c:choose><c:when test="${status.index%2 == 0}">even</c:when><c:otherwise>odd</c:otherwise></c:choose>">
								...
								<td align="center" class="webgridbody" onclick="enFeed.select(<c:out value="${idx.count - 1}"/>);">
									<span class="webgridrowlabel">&nbsp;<c:out value="${feed.allowedText}"/></span>
								</td>
							</tr>
						</c:forEach>
					...
					<div>
						...
						<tr>
						    <td align="right">
								<span class="btn_pack small"><a href="javascript:enFeed.uiRequestForm();"><util:message key="hn.rss.label.add"/></a></span>
						    </td>
						</tr>
						</table>
