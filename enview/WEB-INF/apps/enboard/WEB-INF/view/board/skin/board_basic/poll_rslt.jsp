...
<c:if test="${bpForm.cmd == 'RSLT'}">
  ...
  <table width=640 cellpadding=0 cellspacing=0 border=0>
	...
	<tr align=center height=24>
	  <th class='adgridheader'><util:message key="eb.info.ttl.seq"/></th>
	      ...
	      <tr height="20">
			...
			<td align='right'>
			  <c:if test="${pollA.pollKind == 'A'}"><%--선택형--%>
			    ...
			    <img src="/board/images/board/skin/enboard/i_poll_l.gif" align="absmiddle" alt="Poll" /><img src="/board/images/board/skin/enboard/i_poll_c.gif" align="absmiddle" width="<c:out value="${pollA.pollGraphSize}"/>" height="12" alt="Poll" /><img src="/board/images/board/skin/enboard/i_poll_r.gif" align="absmiddle" alt="Poll" />
			  </c:if>
			  <c:if test="${pollA.pollKind == 'B'}"><%--서술형--%>
...
<c:if test="${bpForm.cmd == 'INS-RSLT'}">
  <table width=360 cellpadding=0 cellspacing=0 border=0>
	...
	<tr><td height=2 colspan=2 class="adgridlimit"></td></tr>
	<tr height=24>
	  <td class="adgridheader" align="center"><util:message key="eb.info.ttl.seq"/></td>
...
<script language="javascript">
	...
	if (currentPage > setSize) {
		...
		firstP  = "<img src='"+imgUrl+pfpImg+"' align=absmiddle border=0 alt='맨 앞 페이지로 가기' />"; 
		prevSet = "<img src='"+imgUrl+ppsImg+"' align=absmiddle border=0 alt='열 페이지 앞으로 가기'/>"; 
	}
	...
	if ( totalPage > endPage) {
		...
		lastP  = "<img src='"+imgUrl+plpImg+"' align=absmiddle border=0 alt='맨 끝 페이지로 가기' />"; 
		nextSet = "<img src='"+imgUrl+pnsImg+"' align=absmiddle border=0 alt='열 페이지 뒤로 가기' />"; 
	}
