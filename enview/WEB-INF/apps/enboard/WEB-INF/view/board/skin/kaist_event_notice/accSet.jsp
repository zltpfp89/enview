...
<link href="<%=request.getContextPath()%>/board/css/admin/admin-common.css" rel="stylesheet" type="text/css"/>
	  ...
	  <td valign=top class=adgridpanel>
	    <table width=100%>
		  ...
		  <tr height=22 <c:if test="${status.index / 2 == 1}">class=adgridline</c:if> prinId="<c:out value="${bltnAuth.prinId}"/>">
			<td class=adgrid>
			  <c:if test="${bltnAuth.prinType == 'G'}"><util:message key="eb.prop.group"/></c:if>
