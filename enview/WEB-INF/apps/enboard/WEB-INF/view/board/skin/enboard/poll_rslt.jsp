	      ...
	      <tr height="20">
			...
			<td align='right'>
			  <c:if test="${pollA.pollKind == 'A'}"><%--선택형--%>
			    ...
			    <img src="/board/images/board/skin/enboard/i_poll_l.gif" align="absmiddle"><img src="/board/images/board/skin/enboard/i_poll_c.gif" align="absmiddle" width="<c:out value="${pollA.pollGraphSize}"/>" height="12"><img src="/board/images/board/skin/enboard/i_poll_r.gif" align="absmiddle">
			  </c:if>
			  <c:if test="${pollA.pollKind == 'B'}"><%--서술형--%>
  ...
  <form name="pageForm">
	...
	<script language="javascript">
		...
		function nextPollInsR(pg) {
			...
			document.pageForm.action = 'poll.brd?cmd=RSLT';
