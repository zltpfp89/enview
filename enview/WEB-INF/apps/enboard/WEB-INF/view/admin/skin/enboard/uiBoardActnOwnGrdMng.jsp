	  ...
	  <tbody>
	    ...
	    <tr><td height=10 colspan=4></td></tr>
	      <td align=right colspan=4>
			...
			<span class="btn_pack medium"><a href="javascript:aBM.getActnMngr().doOwnGrdDelete()"><util:message key="ev.title.remove"/></a></span>
	      </td>
	    </tr>
	  </tbody>
        ...
        <table width=100% cellpadding=0 cellspacing=0 border=0>
	      ...
	      <tr>
	        <td align=right colspan=2>
			  <span class="btn_pack medium"><a href="javascript:aBM.getActnMngr().doOwnGrdSave()"><util:message key="ev.title.save"/></a></span>
	         </td>
	      </tr>
        </table>
		</form>
