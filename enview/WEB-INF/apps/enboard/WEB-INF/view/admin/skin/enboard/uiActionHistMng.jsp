...
<div class="sub_contents">
	<div class="detail">
		<div id="actHistViewTabs" class="board first">
			<ul>
				<li><a href="#userViewTab" onclick="admActHistMngr.onSelectViewTabs(0)"><util:message key="ev.title.statistics.accessByUser"/></a></li>
				<li><a href="#boardViewTab" onclick="admActHistMngr.onSelectViewTabs(1)"><util:message key="ev.title.statistics.accessByBoard"/></a></li>
			</ul>
...
<c:if test="${aaForm.view == 'onlyUbSelectBox'}">
	...
	<table cellpadding=0 cellspacing=0 border=0 class="table_board">
		...
		<thead>
			<tr>
				...
				<th ><span class="table_title"><util:message key="mm.title.id"/></span></th>
				<th ><span class="table_title"><util:message key="eb.info.ttl.name"/></span></th>
			</tr>
		</thead>
		<tbody>
	...
	<c:if test="${aaForm.cmd == 'board' && aaForm.act != 'cateBoard'}"> <%--게시판별 현황--%>
		<div class="sub_contents">
			<div id="brdCateTreeBox" class="tree2" style="float:left;display:inline-block;" ></div>
...
<c:if test="${aaForm.view == 'onlyUbSelectBox' && aaForm.cmd == 'board' && aaForm.act == 'cateBoard'}">	
	...
	<table cellpadding=0 cellspacing=0 border=0 class="table_board">
		...
		<thead>
			<tr>
				<th class="first"><span class="table_title"><util:message key="mm.title.id"/></span></th>
				<th><span class="table_title"><util:message key="cf.prop.boardNm"/></span></th>
				<th><span class="table_title"><util:message key="ev.info.title"/></span></th>
				<th><span class="table_title"><util:message key="cf.title.skin"/></span></th>
				<th><span class="table_title"><util:message key="eb.prop.updDatim"/></span></th>
			</tr>
		</thead>
		<tbody>
		<c:if test="${empty boardVOs}">
			<tr><td class="C" colspan=5><util:message key="eb.error.no.attachedBoard"/></td></tr>
		</c:if>
		<c:if test="${!empty boardVOs}">
		...
		<thead>
			<tr>
				...
				<th>
					...
					<c:if test="${aaForm.cmd == 'user'}"><util:message key="cf.prop.boardNm"/></c:if>
					<c:if test="${aaForm.cmd == 'board'}"><util:message key="hn.note.label.user"/></c:if>
					</span>
				</th>
				<th><span class="table_title"><util:message key="eb.info.title.write"/></span></th>
				<th><span class="table_title"><util:message key="cf.title.reply"/></span></th>
				<th><span class="table_title"><util:message key="cf.title.comment"/></span></th>
				<th><span class="table_title"><util:message key="eb.prop.write.comment.reply"/></span></th>
			</tr>
		</thead>
		<tbody>
...
<div class="board">
	<table cellpadding=0 cellspacing=0 border=0 class="table_board">
		...
		<thead>
			<tr>
				<th class="first"><span class="table_title"><util:message key="ev.prop.useDate"/></span></th>
				<th><span class="table_title"><util:message key="ev.prop.userStatistics.userIp"/></span></th>
				<th><span class="table_title"><util:message key="ev.prop.noticeNum"/></span></th>
				<th><span class="table_title"><util:message key="ev.prop.useFunction"/></span></th>
			</tr>
		</thead>
		<tbody>
