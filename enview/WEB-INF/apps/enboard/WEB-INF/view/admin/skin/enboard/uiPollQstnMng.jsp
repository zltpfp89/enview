		...
		<div class="board">
			<form name="apmQstnEditForm" method="post" action="" onsubmit="return false">
				...
				<caption>게시판 리스트</caption>
					...
					<thead>
						<tr>
							<th class="first"><util:message key="eb.info.ttl.seq"/></th>
			...
			<tr>
				<td class="L">
			 	...
			 	<td class="R">
					...
					<div class="btnArea">
						<div class="rightArea">
							<a href="javascript:aPM.getQstnMngr().pollRequest('qList')" class="btn_B"><span><util:message key="ev.prop.list"/></span></a>
							<c:if test="${sessionScope._enview_user_info_.hasAdminRole || sessionScope._enview_user_info_.hasManagerRole || (sessionScope._enview_user_info_.hasDomainManagerRole && sessionScope._user_domain_.domainId == boardVO.domainId)}">
								<a href="javascript:aPM.getQstnMngr().pollRequest('qSave')" class="btn_B"><span><util:message key="ev.title.save"/></span></a>
								<a href="javascript:aPM.getQstnMngr().pollRequest('qDel')" class="btn_B"><span><util:message key="ev.title.remove"/></span></a>
							</c:if>							
						</div>
					</div>
					<!-- btnArea//-->	
...
<c:if test="${apForm.view == 'editA'}">
	<div class="board">
		...
		<div class="btnArea">
			<div class="rightArea">
		  		<a href="javascript:aPM.getQstnMngr().pollRequest('aList')" class="btn_B"><span><util:message key="ev.prop.list"/></span></a>
		  		<c:if test="${sessionScope._enview_user_info_.hasAdminRole || sessionScope._enview_user_info_.hasManagerRole || (sessionScope._enview_user_info_.hasDomainManagerRole && sessionScope._user_domain_.domainId == boardVO.domainId)}">
					<a href="javascript:aPM.getQstnMngr().pollRequest('aSave')" class="btn_B"><span><util:message key="ev.title.save"/></span></a>
					<a href="javascript:aPM.getQstnMngr().pollRequest('aDel')" class="btn_B"><span><util:message key="ev.title.remove"/></span></a>
				</c:if>							
			</div>
		</div>
		<!-- btnArea//-->
