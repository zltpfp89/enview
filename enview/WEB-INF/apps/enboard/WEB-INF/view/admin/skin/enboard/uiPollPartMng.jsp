				...
				<c:if test="${sessionScope._enview_user_info_.hasAdminRole || sessionScope._enview_user_info_.hasManagerRole || (sessionScope._enview_user_info_.hasDomainManagerRole && sessionScope._user_domain_.domainId == boardVO.domainId)}">
					<div class="btnArea">
						<div class="rightArea">
							...
							<a href="javascript:aPM.getPartMngr().doRemRGU('role')" class="btn_B"><span><util:message key="ev.title.remove"/></span></a>
						</div>
					</div>
				</c:if>
				<!-- btnArea//-->		
			...
			<form id="gradeGroupMngForm" name="gradeGroupMngForm" onsubmit="return false">
				...
				<div class="btnArea">
					<div class="rightArea">
						...
						<a href="javascript:aPM.getPartMngr().doRemRGU('group')" class="btn_B"><span><util:message key="ev.title.remove"/></span></a>
					</div>
				</div>
				</c:if>
				<!-- btnArea//-->		
				...
				<!-- tcontrol//-->
					...
					<div class="btnArea">
						<div class="rightArea">
							...
							<a href="javascript:aPM.getPartMngr().doRemRGU('user')')" class="btn_B"><span><util:message key="ev.title.remove"/></span></a>
						</div>
					</div>
					<!-- btnArea//-->
				</c:if>
					...
					<thead>
						<tr style="cursor:pointer;width:10%">
							<th class="first">
						  	...
						  	<th class="C" ch="0" width=40%><span class="table_title"><util:message key="ev.prop.securityUserRole.roleId"/></span></th>
						  	<th class="C" ch="0" width=50%><span class="table_title"><util:message key="ev.prop.o.roleName"/></span></th>
						</tr>
					</thead>
					<tbody>
						<c:forEach items="${roleList}" var="role" varStatus="status">
				...
				<table id="grid-table" cellpadding="0" cellspacing="0" summary="게시판" class="table_board">			
					<thead>
						<tr style="cursor:pointer;width:10%">
							...
							<th class="C" ch="0" width=40%><span class="table_title"><util:message key="ev.title.statistics.groupId"/></span></th>
							<th class="C" ch="0" width=50%><span class="table_title">><util:message key="ev.title.o.groupName"/><</span></th>
						</tr>
					</thead>
					<tbody>
						<c:forEach items="${groupList}" var="group" varStatus="status">
