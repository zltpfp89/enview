...
<c:if test="${apForm.view == 'edit'}">
	...
	<div class="board">	
		...
		<div class="btnArea">
			<div class="rightArea">
				<a href="javascript:aPM.getEvalMngr().pollRequest('list')" class="btn_B"><span><util:message key="ev.prop.list"/></span></a>
				<c:if test="${sessionScope._enview_user_info_.hasAdminRole || sessionScope._enview_user_info_.hasManagerRole || (sessionScope._enview_user_info_.hasDomainManagerRole && sessionScope._user_domain_.domainId == boardVO.domainId)}">
					<a href="javascript:aPM.getEvalMngr().pollRequest('save')" class="btn_B"><span><util:message key="ev.title.save"/></span></a></span>
					<a href="javascript:aPM.getEvalMngr().pollRequest('del')" class="btn_B"><span><util:message key="ev.title.remove"/></span></a></span>
				</c:if>						
			</div>
		</div>
		<!-- btnArea//-->
