...
<div class="sub_contents">
	<div class="detail">
			...
			<div class="board first">
				...
				<div class="tsearchArea">
					...
					<fieldset>
						<form name="frmML" method="post" action="" onsubmit="return false">
							...
							<input type="text" name="srchUserId" class="txt_100" onfocus="ebUtil.whenSrchFocus(this,'<util:message key="eb.info.ttl.l.userId"/>');" onblur="ebUtil.whenSrchBlur(this,'<util:message key="eb.info.ttl.l.userId"/>');"
								<c:if test="${empty amForm.srchUserId}">value="<util:message key="eb.info.ttl.l.userId"/>"</c:if><c:if test="${!empty amForm.srchUserId}">value="<c:out value="${amForm.srchUserId}"/>"</c:if>>
							<input type="text" name="srchMileCd" class="txt_100" onfocus="ebUtil.whenSrchFocus(this,'<util:message key="eb.info.ttl.l.mileCd"/>');" onblur="ebUtil.whenSrchBlur(this,'<util:message key="eb.info.ttl.l.mileCd"/>');"
				...
				<table cellpadding="0" cellspacing="0" border="0" class="table_board">
					...
					<tr >
						...
						<th ><span class="table_title"><util:message key="eb.title.mileDatim"/></span></th>
						<th ><span class="table_title"><util:message key="ev.title.statistics.userId"/></span></th>
						<th ><span class="table_title"><util:message key="eb.title.mileage"/></span></th>
						<th ><span class="table_title"><util:message key="eb.title.add.sub"/></span></th>
						<th ><span class="table_title"><util:message key="eb.title.occur"/></span></th>
						<th ><span class="table_title"><util:message key="eb.title.sum"/></span></th>
					</tr>
					</thead>
					<tbody>
					<c:forEach items="${mileList}" var="mile" varStatus='status'>
						<tr id='mileTr<c:out value="${status.index}"/>'	onclick="ebUtil.selectTr('mileTr',<c:out value="${status.index}"/>);admMileageMngr.onMileageList('edit','sel','<c:out value="${mile.userId}"/>','<c:out value="${mile.mileCd}"/>','<c:out value="${mile.mileDatim}"/>');">
							...
							<td class="C">
								<c:if test="${mile.mileIo == 'I'}"><util:message key="eb.prop.increase"/></c:if>
								<c:if test="${mile.mileIo == 'O'}"><util:message key="eb.prop.decrease"/></c:if>
							</td>
		...
		<table cellpadding=0 cellspacing=0 border=0 class="table_board">
			...
			<tr >
				<th class="L"><util:message key="ev.title.statistics.userId"/></th>
				...
				<th class="L"><util:message key="eb.title.mileDatim"/></th>
			...
			<tr >
				<th class="L"><util:message key="eb.title.mildCd"/></th>
				...
				<th class="L"><util:message key="ev.prop.codebase.domain"/></th>
				<td class="L">
			...
			<tr >
				<th class="L"><util:message key="eb.prop.mileSys"/></th>
				<td class="L">
				...
				<th class="L"><util:message key="eb.info.mileIo"/></th>
				<td class="L">
			...
			<tr >
				<th class="L"><util:message key="eb.info.groupRole"/></th>
				<td class="L">
			...
			<tr >
				...
				<th class="L"><util:message key="eb.info.ttl.mileSum"/></th>
				<td class="L">
			...
			<tr >
				<th class="L"><util:message key="eb.title.statistics.reserveCode"/>1</th>
				<td class="L">
					<input type="text" name="sttsCd1" id="sttsCd1" class="txt_100" maxlength=10 value=<c:out value="${mileVO.sttsCd1}"/>>
				</td>
				<th class="L"><util:message key="eb.title.statistics.reserveCode"/>2</th>
				<td class="L">
			...
			<tr >
				<th class="L"><util:message key="eb.title.statistics.reserveCode"/>3</th>
				<td class="L">
		...
		<div class="btnArea"> 
			<div class="rightArea">
				<a href="javascript:admMileageMngr.onMileageForm('list')" class="btn_B"><span><util:message key="ev.prop.list"/></span></a>
				...
				<a href="javascript:admMileageMngr.onMileageForm('save')" class="btn_B"><span><util:message key="ev.title.save"/></span></a>
