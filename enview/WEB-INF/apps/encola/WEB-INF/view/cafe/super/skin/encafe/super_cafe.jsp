...
%>
<style>
#leftSub {background-color: white;padding: 5px;margin-top:1px;font-size: 13px}
#leftSub ul li{padding-top:5px; padding-bottom:5px; padding-left:20px; cursor:pointer;}
.tree_title {margin-top: 3px}
</style>
<<script type="text/javascript">
$( function() {
	
	
	$( "#bltn_srchBgnReg" ).datepicker().on('change', function (e) { 
		 $( "#bltn_srchEndReg" ).datepicker( "option", "minDate", $( "#bltn_srchBgnReg" ).datepicker().val());
	});
	$( "#bltn_srchEndReg" ).datepicker(); 

	
	$( "#memo_srchBgnReg" ).datepicker().on('change', function (e) { 
		 $( "#memo_srchEndReg" ).datepicker( "option", "minDate", $( "#memo_srchBgnReg" ).datepicker().val());
	});
	$( "#memo_srchEndReg" ).datepicker();
});
		...
		<div class="treewrap resizable">
			<div style="background:#eaeaea;">
				...
				<div class="tsearchArea">
					<div class="tree_title" style="cursor:pointer;" onclick="superMngr.onSelectLeft('cate')">카테고리별 검색</div>
					<div id="leftSub" name="leftSub" opt="cate" >
						<!-- 트리 영역 border로 구분. 지우고 사용해주세요 -->
						<div>
						<div id="superCateTree" style="width: 100%; height:300px; overflow:auto;"></div>
						</div>
						<!-- 카페,기능별,기능별,댓글(메모) 검색 -->
					</div>
					...
					<div id="leftSub" name="leftSub" opt="srch" style="display:none; text-align: right;">
						<div class="sel_100">
							<select id="cafe_srchType" name="cafe_srchType" class="txt_100">
						...
						<input type="text" id="cafe_srchKey" name="cafe_srchKey" class="txt_100" maxlength="30" onKeyPress="if(event.keyCode==13){superMngr.searchCafe();}"/>
						<a href="javascript:superMngr.searchCafe()" class="btn_search" style="margin-top: 5px"><span>검색</span></a>
					</div>
					...
					<div id="leftSub" name="leftSub" opt="func" style="display:none">
						<ul style="list-style-type:none">
							<li><font onclick="superMngr.listCafe('permit')" onmouseover="this.style.textDecoration='underline'" onmouseout="this.style.textDecoration='none'">개설 신청</font></li>
							<li><font onclick="superMngr.listCafe('2close')" onmouseover="this.style.textDecoration='underline'" onmouseout="this.style.textDecoration='none'">폐쇄 신청</font></li>
							<li><font onclick="superMngr.listCafe('closed')" onmouseover="this.style.textDecoration='underline'" onmouseout="this.style.textDecoration='none'">폐쇄 완료</font></li>
							<li><font onclick="superMngr.listCafe('hit')" onmouseover="this.style.textDecoration='underline'" onmouseout="this.style.textDecoration='none'">방문수 순위</font></li>
							<li><font onclick="superMngr.listCafe('mile')" onmouseover="this.style.textDecoration='underline'" onmouseout="this.style.textDecoration='none'">랭킹  순위</font></li>
							<li><font onclick="superMngr.listCafe('mmbr')" onmouseover="this.style.textDecoration='underline'" onmouseout="this.style.textDecoration='none'">회원수 순위</font></li>
							<li><font onclick="superMngr.listCafe('rcmd')" onmouseover="this.style.textDecoration='underline'" onmouseout="this.style.textDecoration='none'">추천 카페</font></li>
						</ul>				
					</div>
					...
					<div id="leftSub" name="leftSub" opt="bltn" style="display:none">
						<table cellpadding="0" cellspacing="0" summary="게시판" class="table_board">
							...
							<tr>
								...
								<td class="L">
									<input type="text" id="bltn_srchBgnReg" value="<c:out value="${suForm.srchBgnRegF}"/>" class="txt_70" readonly="true">
									~
									<input type="text" id="bltn_srchEndReg" value="<c:out value="${suForm.srchEndRegF}"/>" class="txt_70" readonly="true">
								</td>
							</tr>
							<tr>
								<td colspan="2">
							...
							<tr>
								<td colspan="2" class="R">
									<input type="text" id="bltn_srchKey" id="bltn_srchKey" value="<c:out value="${suForm.srchKey}"/>" class="txt_120" maxlength="30" onKeyPress="if(event.keyCode==13){superMngr.searchBltn();}"/>
									<a href="javascript:superMngr.searchBltn()" class="btn_search"><span>검색</span></a>
									<div class="sel_70" style="float:right">
						...
						<table cellpadding="0" cellspacing="0" summary="게시판" class="table_board">
							...
							<tr>
								<th class="R">
							 	...
							 	<td class="L">
									<input type="text" id="memo_srchBgnReg" value="<c:out value="${suForm.srchBgnRegF}"/>" class="txt_70" readonly="true">
									 
									~ <input type="text" id="memo_srchEndReg" value="<c:out value="${suForm.srchEndRegF}"/>" class="txt_70" readonly="true">
							 	</td>
							</tr>
							<tr>
								<td colspan="2" class="R">
							...
							<tr>
								<td colspan="2" class="R">
								 	<input type="text" id="memo_srchKey" id="memo_srchKey" value="<c:out value="${suForm.srchKey}"/>" class="txt_120" maxlength="30" onKeyPress="if(event.keyCode==13){superMngr.searchMemo();}"/>
			...
			<!-- 카페,기능별,기능별,댓글(메모) 검색 -->				
			<!-- tablewrap -->
			<div id="cateTabs" name="leftSub" opt="cate" class="tablewrap">
				<ul>
...
<div id="treeCtxtMenuDiv" title='<util:message key="eb.title.cate"/>' style="display: none">
