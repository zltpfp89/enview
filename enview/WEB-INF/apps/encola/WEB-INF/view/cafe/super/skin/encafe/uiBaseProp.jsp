		...
		<table id="grid-table" cellpadding="0" cellspacing="0" summary="게시판" class="table_board">
			...
			<tr>
				<td class="R" colspan="4">
		    		...
		    		<a href="javascript:superMngr.getBPMngr().doSave('cafe')" class="btn_B"><span><util:message key="ev.title.save"/></span></a>
		  		</td>		
			</tr>				
		</table>	
	</div>
	...
	<div class="board" >
		...
		<div class="btnArea">
			<div class="rightArea">
				...
				<a href="javascript:superMngr.getBPMngr().doSave('board')" class="btn_B"><span><util:message key="ev.title.save"/></span></a>
			</div>
		</div>
		<!-- btnArea//-->
	</div>
...
<c:if test="${suForm.view == 'mcd.edit'}">
	...
	<div id="LangManager_EditFormPanel" class="board" >
		<table id="grid-table" cellpadding="0" cellspacing="0" summary="게시판" class="table_board">
			...
			<tr>
			    <th class="R" style="padding:0px 10px 0px 10px"><util:message key="eb.prop.updUserId"/></th>
			    <td class="L">
			    	<c:out value="${mcdVO.updUserId}"/>
			    </td>
			    <th class="R" style="padding:0px 10px 0px 10px"><util:message key="eb.title.updateDate"/></th>
			    <td class="L">
		...
		<div class="btnArea">
			<div class="rightArea">
				...
				<a href="javascript:superMngr.getBPMngr().doSave('mcd')" class="btn_B"><span><util:message key="ev.title.save"/></span></a>
			</div>
		</div>
		<!-- btnArea//-->	
	</div>
		...
		<form id="mgrdListForm" name="mgrdListForm" onsubmit="return false">
			...
			<div class="btnArea">
				<div class="rightArea">
					...
					<a href="javascript:aConfigurationManager.doRemove()" class="btn_W"><span><util:message key="ev.title.save"/></span></a>
				</div>
			</div>
			<!-- btnArea//-->
		</form>
...
<c:if test="${suForm.view == 'mgrd.edit'}">
	...
	<div id="LangManager_EditFormPanel" class="board" >
		<form id="mgrdEditForm" name="mgrdEditForm" style="display:inline" action="" method="post" onsubmit="return false;">
			...
			<div class="btnArea">
				<div class="rightArea">
					<a href="javascript:superMngr.getBPMngr().doSave('mgrd')" class="btn_B"><span><util:message key="ev.title.save"/></span></a>
					<c:if test="${suForm.act == 'upd'}">
						<a href="javascript:superMngr.getBPMngr().doMGrdDelete()" class="btn_B"><span><util:message key="ev.title.remove"/></span></a>
					</c:if>
				</div>
			</div>
			<!-- btnArea//-->			  
