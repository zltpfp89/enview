	  ...
	  <table width="100%">
	    <tr>
		  ...
		  <td align="right">
			...
			<img src="<%=request.getContextPath()%>/cola/cafe/images/sysop/encafe/btn_search.gif" hspace="2" align="absmiddle" style="cursor:hand" onclick="cfOp.bltnMng.search('ntc_srchForm')"/>
		    ...
		    <td colspan="100" align="right">
			  <span style="margin-right:30px">
			  	<span class="btn_pack small">
					<a href="#" onclick="javascript:cfOp.bltnMng.processNotice('add')">신규</a>
				</span>
			  </span>
			</td>
		  </tr>
      ...
      <table cellpadding=0 cellspacing=0 border=0 width='100%' class="cafeformpanel">
		...
		<tr>
		  <td width=20% class=cafeformlabel>
		    <img src=<%=request.getContextPath()%>/cola/cafe/images/sysop/encafe/tb_icon.gif width=5 height=5 align=absmiddle maxlength=100>
			제    목
		  </td>
		...
		<tr>
		  <td width="20%" class="cafeformlabeldark">
		    <img src="<%=request.getContextPath()%>/cola/cafe/images/sysop/encafe/tb_icon.gif" width="5" height="5" align="absmiddle">
			공지기간
		  </td>
		  <td class="cafeformfielddarklast" align="left">
			...
			<img align="absmiddle" src="<%=request.getContextPath()%>/cola/cafe/images/sysop/encafe/calendar.gif" onclick="displayCalendar(new Date(), 'ntc_startDate', event)">
			부터
			<input type="text" id="ntc_endDate" value="<c:out value="${noticeVO.endDateSF}"/>" style="width:80px" readonly="true">
			<img align="absmiddle" src="<%=request.getContextPath()%>/cola/cafe/images/sysop/encafe/calendar.gif" onclick="displayCalendar(new Date(), 'ntc_endDate', event)">
			까지
		  </td>
		</tr>
		<tr>
		  <td width="20%" class="cafeformlabel"><img src="<%=request.getContextPath()%>/cola/cafe/images/sysop/encafe/tb_icon.gif" width="5" height="5" align="absmiddle">공지내용</td>
		  <td class="cafeformfieldlast" align="left">
		...
		<tr>
		  <td colspan="100" align="right">
		    <span style="margin-right:10px">
			    <span class="btn_pack small">
					<a href="#" onclick="javascript:cfOp.bltnMng.processNotice('save')"><util:message key="ev.title.save"/></a>
				</span>
			</span>
		    <span style="margin-right:10px">
				<span class="btn_pack small">
					<a href="#" onclick="javascript:cfOp.bltnMng.processNotice('del')"><util:message key="ev.title.remove"/></a>
				</span>
			</span>
		  </td>
		</tr>
