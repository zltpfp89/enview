	  ...
	  <table width="100%">
	    <tr>
		  ...
		  <td align="right">
			...
			<img src="<%=request.getContextPath()%>/cola/cafe/images/sysop/encafe/btn_search.gif" hspace="2" align="absmiddle" style="cursor:hand" onclick="cfOp.bltnMng.search('all_srchForm')"/>
		    ...
		    <td colspan="100">
			  ...
			  <span style="margin-left:10px">
				...
				<span class="btn_pack small">
					<a href="#" onclick="javascript:cfOp.bltnMng.moveBulletin('MOVE')">이동</a>
				</span>
			  </span>
			  <span style="margin-left:30px">
				<span class="btn_pack small">
					<a href="#" onclick="javascript:cfOp.bltnMng.moveBulletin('DELETE')"><util:message key="ev.title.remove"/></a>
				</span>
