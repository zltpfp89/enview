...
<div style="width:99%;" class="cafegridpanel">
  <table cellpadding=0 cellspacing=0 border=0 width='100%' class="cafeformpanel">
	...
	<tr>
	  ...
	  <td class="cafeformfieldlast" align="left">
		<input type="text" id="base_cmntNm" name="base_cmntNm" value="<c:out value="${cmntVO.cmntNm}"/>" maxlength="60" class="full_cafetextfield" title="카페 이름"/>
	  </td>
	</tr>
	<tr>
	...
	<tr>
	  <td width="20%" class="cafeformlabel"><img src="<%=request.getContextPath()%>/cola/cafe/images/tb_icon.gif" width="5" height="5" align="absmiddle">가입 방식</td>
	  <td class="cafeformfieldlast" align="left">
	...
	<tr>
	  <td width="20%" class="cafeformlabel"><img src="<%=request.getContextPath()%>/cola/cafe/images/tb_icon.gif" width="5" height="5" align="absmiddle">회원명 표시 방식</td>
	  <td class="cafeformfieldlast" align="left">
	...
	<tr>
	  <td width="20%" class="cafeformlabel"><img src="<%=request.getContextPath()%>/cola/cafe/images/tb_icon.gif" width="5" height="5" align="absmiddle">가입 환영 인사</td>
	  <td class="cafeformfieldlast" align="left">
	    <textarea id="base_cmntWelcome" name="base_cmntWelcome" style="width:98%;height:70px"><c:out value="${cmntVO.cmntWelcome}"/></textarea>
	  </td>
	</tr>
	<!--tr>
	  <td width="20%" class="cafeformlabel"><img src="<%=request.getContextPath()%>/cola/cafe/images/tb_icon.gif" width="5" height="5" align="absmiddle">소모임 개설 허용 갯수</td>
  ...
  <table style="width:100%;">
	<tr>
	  <td align="right">  
		<input type=button value="저장" style="cursor:hand" onclick="cfOp.baseInfo.checkBaseInfoBase()">
	  </td>
	</tr>
  </table>
</div>
