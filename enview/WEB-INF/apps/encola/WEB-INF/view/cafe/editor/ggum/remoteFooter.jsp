		  ...
		  <div id="remoteFooterView" class="remoteZindexL">
			<div class="skinView_footer">
			  <div class="fl">
				...
				<label class="hand" for="controlUseTitle"><util:message key="cf.title.keep.title"/></label>
			  </div>
			</div>
		  </div>
		  <a class="rollback home_stxt" onclick="cfGGum.getFootMngr().resetOrg(); return false;" href="#"><util:message key="cf.prop.backAgain"/></a>
	</c:if>
<%--END::스킨/스킨--%>
<%--BEGIN::스킨/배경--%>
	...
	<c:if test="${edForm.ggumSubMenu == 'portlet'}">
		  <div id="remoteFooterView" class="remoteZindexL">
			<div class="widgetView_footer">
			  <a class="linkWidgetBank home_stxt555" target="_blank" href="http://widgetbank.daum.net"><util:message key="cf.prop.more.widget"/></a>
			</div>
		  </div>
		  <a class="rollback home_stxt" onclick="cfGGum.getFootMngr().resetOrg(); return false;" href="#"><util:message key="cf.prop.backAgain"/></a>
	</c:if>
...
<c:if test="${edForm.ggumMenu == 'ggumigi'}">
	<c:if test="${edForm.ggumSubMenu == 'info'}">
		  <div id="remoteFooterView" class="remoteZindexL">
			<ul id="FooterColor">
			  <li>
				<span class="color_label"><util:message key="cf.prop.basicColor"/></span>
			  ...
			  <li>
				<span class="color_label"><util:message key="cf.prop.highlightColor"/></span>
			  ...
			  <li id="isTabOption1" style="display: none;">
				<span class="color_label"><util:message key="cf.prop.tabName"/></span>
		  ...
		  <a class="rollback home_stxt" onclick="cfGGum.getTplMngr().reset();" href="#"><util:message key="cf.prop.backAgain"/></a>
	</c:if>
<%--END::영역별꾸미기/카페정보--%>
<%--BEGIN::영역별꾸미기/카페메뉴--%>
	<c:if test="${edForm.ggumSubMenu == 'menu'}">
		  <div id="remoteFooterView" class="remoteZindexL">
			<ul id="FooterColor">
			  ...
			  <li>
				<span class="color_label"><util:message key="cf.prop.icon"/></span>
...
<%--BEGIN::영역별꾸미기/게시판--%>
	<c:if test="${edForm.ggumSubMenu == 'board'}">
		  <div id="remoteFooterView" class="remoteZindexL">
			<ul id="FooterColor">
			  <li>
				<span class="color_label"><util:message key="cf.title.boardName"/></span>
			  ...
			  <li>
				<span class="color_label"><util:message key="cf.prop.titleColor"/></span>
			  ...
			  <li>
				<span class="color_label"><util:message key="cf.title.commentColor"/></span>
		  ...
		  <a class="rollback home_stxt" onclick="cfGGum.getTplMngr().reset(); return false;" href="#"><util:message key="cf.prop.backAgain"/></a>
	</c:if>
<%--END::영역별꾸미기/게시판--%>
<%--BEGIN::영역별꾸미기/부가컨텐츠--%>
