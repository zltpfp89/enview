...
<DL>
<DT id=componentTitleText class=cafeinfo><util:message key="ev.title.pageEditing.ContentTitle"/> </DT>
<DD><A onclick="(new cube.controller.title.EditorLayerController()).onClickCancel(); return false;" href="#"><util:message key="ev.title.close"/></A> </DD></DL>
...
<P><util:message key="cf.info.makeTitle"/></P>
<UL>
...
<UL class=control>
<LI class=control><LABEL><util:message key="cf.prop.backgroundColor"/></LABEL> 
...
<LI class=control><LABEL><util:message key="cf.prop.border"/></LABEL> 
...
<DIV class=colorSelectEnabled></DIV></DIV></LI>
<LI class=control><LABEL><util:message key="cf.prop.transparency"/></LABEL> 
...
<DL>
<DT>
<DIV class=priview_img><IMG id=previewUserImage src="http://cfile283.uf.daum.net/P100x100/183CB2374FB1DE51324BB0"> </DIV><A id=btnImageDelete onclick="(new cube.controller.title.BackgroundController()).onClickDeleteImage();"><util:message key="ev.hnevent.label.delete"/></A> </DT>
<DD>
<UL>
<LI class=control>
<DIV><LABEL class=title_stxt555><util:message key="cf.prop.img"/></LABEL> 
...
<c:if test="${langKnd eq 'en' }">
	<P class=notice>1MB / jpg, gif</P>
	<P>971px</P></LI>
</c:if>
<LI class=control><LABEL class=title_stxt555><util:message key="cf.prop.size"/></LABEL> 
	<A style="WIDTH: 53px" id=d2w_titleUserRepeat class=img_selectbox tabIndex=0><util:message key="cf.prop.repeat.all"/></A>
	<SELECT id=titleUserRepeat onchange="(new cube.controller.title.BackgroundController()).onClickUserImageRepeat(this.value);" class=selectbox_styled> <OPTION value=no-repeat><util:message key="Original size"/></OPTION> <OPTION selected value=repeat><util:message key="cf.prop.repeat.all"/></OPTION></SELECT>
</LI>
<LI class=control><LABEL class=title_stxt555><util:message key="cf.prop.background"/></LABEL> 
...
<LI class=control><LABEL class=title_stxt555><util:message key="cf.prop.location"/></LABEL> 
...
<DIV style="BACKGROUND-IMAGE: none; WIDTH: 91px; DISPLAY: none" class=layer_btns><A class=btn_s_config onclick="(new cube.controller.title.MenuGroupController()).onClickMenuBtns(0, 'edit');"><util:message key="ev.hnevent.common.setting"/></A><A class=btn_s_remove onclick="(new cube.controller.title.MenuGroupController()).onClickMenuBtns(0, 'delete');"><util:message key="ev.hnevent.label.delete"/></A></DIV></DIV>
<DIV><A class="menu1 first"><util:message key="cf.prop.view.Recentpost"/></A></DIV></LI>
<LI class=mbar>|</LI>
<LI class=on>
<DIV style="BACKGROUND-IMAGE: none; WIDTH: 93px; HEIGHT: 35px" class=menu_layer>
<DIV style="BACKGROUND-IMAGE: none; WIDTH: 91px; HEIGHT: 33px" class=inner_layer>
<DIV style="BACKGROUND-IMAGE: none; BACKGROUND-COLOR: #fff; WIDTH: 91px; HEIGHT: 33px" class=inner_layer_blind></DIV></DIV>
<DIV style="BACKGROUND-IMAGE: none; WIDTH: 91px; DISPLAY: none" class=layer_btns><A class=btn_s_config onclick="(new cube.controller.title.MenuGroupController()).onClickMenuBtns(1, 'edit');"><util:message key="ev.hnevent.common.setting"/></A><A class=btn_s_remove onclick="(new cube.controller.title.MenuGroupController()).onClickMenuBtns(1, 'delete');"><util:message key="ev.hnevent.label.delete"/></A></DIV></DIV>
<DIV><A class=menu2><util:message key="cf.prop.view.popularPost"/></A></DIV></LI>
<LI class=mbar>|</LI>
<LI>
<DIV style="BACKGROUND-IMAGE: none; WIDTH: 93px; HEIGHT: 35px" class=menu_layer>
<DIV style="BACKGROUND-IMAGE: none; WIDTH: 91px; HEIGHT: 33px" class=inner_layer>
<DIV style="BACKGROUND-IMAGE: none; BACKGROUND-COLOR: #fff; WIDTH: 91px; HEIGHT: 33px" class=inner_layer_blind></DIV></DIV>
<DIV style="BACKGROUND-IMAGE: none; WIDTH: 91px; DISPLAY: none" class=layer_btns><A class=btn_s_config onclick="(new cube.controller.title.MenuGroupController()).onClickMenuBtns(2, 'edit');"><util:message key="ev.hnevent.common.setting"/></A><A class=btn_s_remove onclick="(new cube.controller.title.MenuGroupController()).onClickMenuBtns(2, 'delete');"><util:message key="ev.hnevent.label.delete"/></A></DIV></DIV>
<DIV><A class=menu3><util:message key="cf.prop.viewImage"/></A></DIV></LI>
<LI class=mbar>|</LI>
<LI>
<DIV style="BACKGROUND-IMAGE: none; WIDTH: 93px; HEIGHT: 35px" class=menu_layer>
<DIV style="BACKGROUND-IMAGE: none; WIDTH: 91px; HEIGHT: 33px" class=inner_layer>
<DIV style="BACKGROUND-IMAGE: none; BACKGROUND-COLOR: #fff; WIDTH: 91px; HEIGHT: 33px" class=inner_layer_blind></DIV></DIV>
<DIV style="BACKGROUND-IMAGE: none; WIDTH: 91px; DISPLAY: none" class=layer_btns><A class=btn_s_config onclick="(new cube.controller.title.MenuGroupController()).onClickMenuBtns(3, 'edit');"><util:message key="ev.hnevent.common.setting"/></A><A class=btn_s_remove onclick="(new cube.controller.title.MenuGroupController()).onClickMenuBtns(3, 'delete');"><util:message key="ev.hnevent.label.delete"/></A></DIV></DIV>
<DIV><A class=menu4><util:message key="cf.prop.viewVideo"/></A></DIV></LI>
<LI class=mbar>|</LI>
<LI>
...
<DIV style="BACKGROUND-IMAGE: none; WIDTH: 115px; DISPLAY: none" class=layer_btns><A class=btn_s_config onclick="(new cube.controller.title.MenuGroupController()).onClickMenuBtns(4, 'edit');"><util:message key="ev.hnevent.common.setting"/></A><A class=btn_s_remove onclick="(new cube.controller.title.MenuGroupController()).onClickMenuBtns(4, 'delete');"><util:message key="ev.hnevent.label.delete"/></A></DIV></DIV>
<DIV><A class=menu5><util:message key="cf.prop.ourStory"/></A></DIV></LI></UL>
<DIV class=roundR></DIV></DIV><!-- end barPreviewer --></DIV><!-- end previewBarBox -->
<UL class=bar_control>
<LI><LABEL class=title_txt555><util:message key="cf.prop.basicColor"/></LABEL> 
...
<DIV class=colorSelectEnabled></DIV></DIV></LI>
<LI><LABEL class=title_txt555><util:message key="cf.prop.selectColor"/></LABEL> 
...
<DIV class=colorSelectEnabled></DIV></DIV></LI>
<LI style="DISPLAY: none" id=barColorControl><LABEL class=title_txt555><util:message key="cf.prop.background.Color"/></LABEL>
...
<DIV class=colorSelectEnabled></DIV></DIV></LI>
<LI class=menu_add><A class=btn_addmenu onclick="(new cube.controller.title.MenuGroupController()).onClickAddMenu(); return false;" href="http://cafe456.daum.net/_c21_/founder_title_management?grpid=1NjB9#"><util:message key="cf.prop.addMenu"/></A> </LI></UL></DIV><!-- end barDesignBox -->
...
<LI class=control><LABEL class=title_txt555><util:message key="cf.prop.fontColor"/></LABEL> 
...
<DIV class=colorSelectEnabled></DIV></DIV></LI>
<LI id=btnColorControl class=control><LABEL class=title_txt555><util:message key="cf.prop.IconColor"/></LABEL> 
...
<DIV class=colorSelectEnabled></DIV></DIV></LI>
<LI class=menu_add><A class=btn_addmenu onclick="(new cube.controller.title.MenuGroupController()).onClickAddMenu(); return false;" href="http://cafe456.daum.net/_c21_/founder_title_management?grpid=1NjB9#"><util:message key="cf.prop.addMenu"/></A> </LI></UL></DIV><!-- end btnDesignBox -->
...
<DT><util:message key="cf.prop.detailSet"/></DT>
...
<LI class=control><LABEL><util:message key="cf.prop.menu"/></LABEL> 
<DIV id=menuItemListArea><A style="WIDTH: 154px" id=d2w_menuItemSelector class=img_selectbox tabIndex=0><util:message key="cf.prop.cafeAlbum"/></A>
<SELECT id=menuItemSelector onchange="(new cube.controller.title.MenuGroupController()).onSelectMenuItem(this);" class=selectbox_styled scrollsize="112" fixedsize="189">    
	<OPTION selected value=EEvv><util:message key="cf.prop.cafeAlbum"/></OPTION> 
	<OPTION value=EEvw><util:message key="cf.prop.boardQna"/></OPTION> 
	<OPTION value=_memo><util:message key="cf.prop.oneLine.talk"/></OPTION> 
	<OPTION value=EEvx><util:message key="cf.prop.rssBoard"/></OPTION>  
</SELECT> 
<DIV style="DISPLAY: none" id=hiddenBoardTip class=tip_icon></DIV>
<DIV style="DISPLAY: none" id=noBoardTip class=tip_icon></DIV>
<SELECT style="DISPLAY: none" id=tempMenuItemSelector> 
	<OPTION selected value=_rec><util:message key="cf.prop.view.Recentpost"/></OPTION> 
	<OPTION value=_fav><util:message key="cf.prop.view.popularPost"/></OPTION> 
	<OPTION value=EEvu><util:message key="cf.prop.ourStory"/></OPTION> 
	<OPTION value=EEvv><util:message key="cf.prop.cafeAlbum"/></OPTION> 
	<OPTION value=EEvw><util:message key="cf.prop.boardQna"/></OPTION> 
	<OPTION value=_memo><util:message key="cf.prop.oneLine.talk"/></OPTION> 
	<OPTION value=EEvx><util:message key="cf.prop.rssBoard"/></OPTION> 
	<OPTION value=_image><util:message key="cf.prop.viewImage"/></OPTION> 
	<OPTION value=_movie><util:message key="cf.prop.viewVideo"/></OPTION></SELECT></DIV></LI>
<LI class=control><LABEL><util:message key="cf.title.menuName"/></LABEL> <INPUT id=menuItemName class=cube_input maxLength=22>
<DIV id=menuItemName_counter class=counter><STRONG id=menuItemName_cnt>0</STRONG>/10<util:message key="cf.prop.characters"/></DIV> </LI>
<LI class=control>
<DIV style="DISPLAY: none" id=btnIconSelectArea><LABEL><util:message key="cf.prop.icon"/></LABEL> 
<DIV id=iconSelector>
<DIV id=selectedIconBox>&nbsp;</DIV></DIV></DIV></LI></UL>
<DIV style="DISPLAY: none" id=noticeBoardText><util:message key="cf.info.please.selectBoard"/></DIV>
<DIV class=config_footer><A onclick="(new cube.controller.title.MenuGroupController()).onClickConfigConfirm(); return false;" href="http://cafe456.daum.net/_c21_/founder_title_management?grpid=1NjB9#"><IMG class=btn_config_confirm alt=확인 src="http://i1.daumcdn.net/cafeimg/cf_img2/img_blank2.gif" width=38 height=21> </A><A onclick="(new cube.controller.title.MenuGroupController()).onClickConfigCancel(); return false;" href="http://cafe456.daum.net/_c21_/founder_title_management?grpid=1NjB9#"><IMG class=btn_config_cancel alt=취소 src="http://i1.daumcdn.net/cafeimg/cf_img2/img_blank2.gif" width=38 height=21> </A></DIV></DIV><!-- end menuItemConfigLayer --></DIV><!-- end detailDesignArea --><A id=btnDesignSelect class=dropdown onclick="(new cube.controller.title.MenuGroupController()).onClickDesignSetArea(this); return false;" href="http://cafe456.daum.net/_c21_/founder_title_management?grpid=1NjB9#"><util:message key="cf.prop.select.menuDesign"/></A> 
<DIV id=menuDesignSetArea>
<UL class=menu_category>
<LI><IMG id=d2w_radioTypeBar class="img_radiobtn rb_checked" tabIndex=0 src="http://i1.daumcdn.net/cafeimg/cf_img2/img_blank2.gif" width=13 height=14><INPUT id=radioTypeBar class=checkradio_styled onclick="(new cube.controller.title.MenuGroupController()).onClickMenuType('BAR');" name=menucategory value=BAR CHECKED type=radio><LABEL class="title_stxt555 hand"><util:message key="cf.prop.barType"/></LABEL> </LI>
<LI><IMG id=d2w_radioTypeBtn class=img_radiobtn tabIndex=0 src="http://i1.daumcdn.net/cafeimg/cf_img2/img_blank2.gif" width=13 height=14><INPUT id=radioTypeBtn class=checkradio_styled onclick="(new cube.controller.title.MenuGroupController()).onClickMenuType('BTN');" name=menucategory value=BTN type=radio><LABEL class="title_stxt555 hand"><util:message key="cf.prop.buttonType"/></LABEL> </LI></UL>
...
<DD><LABEL><util:message key="cf.prop.title.color"/></LABEL> 
...
<DD class=last><LABEL><util:message key="cf.prop.numberColor"/></LABEL> 
...
<DD><LABEL><util:message key="cf.prop.background"/></LABEL> 
...
<DIV class=colorSelectEnabled></DIV></DIV></DD>
<DD><LABEL><util:message key="cf.prop.transparency"/></LABEL> 
<DIV id=alphaSlider>
...
<DD class=last><LABEL id=borderLabel><util:message key="cf.prop.border"/></LABEL> 
...
<DIV class=colorSelectDisabled></DIV></DIV></DD></DL></DIV><A id=btnOpenDesign class=dropdown onclick="(new cube.controller.title.CafeInfoController()).onClickDesignSetArea(this); return false;" href="http://cafe456.daum.net/_c21_/founder_title_management?grpid=1NjB9#"><util:message key="cf.prop.select.counterDesign"/></A> 
...
<TBODY>
<TR>
<TD><SPAN class="pg_btn prev_btn"><util:message key="hn.note.label.prev"/></SPAN> <SPAN class=page_selected>1</SPAN> <A onclick="(new cube.controller.title.CafeInfoController()).onClickPage('', '', '2', '1');return false;" href="http://cafe456.daum.net/_c21_/founder_title_management?grpid=1NjB9#">2</A> <SPAN class="pg_btn next_btn"><util:message key="hn.note.label.next"/></SPAN> </TD></TR></TBODY></TABLE></DIV></DIV></DIV></DIV></DIV></DIV></DIV>
