...
<html>
	<head>
		<title><util:message key="cf.prop.titleDeco"/></title>
		...
		<link id = "themeCss" rel="stylesheet" type="text/css" media="screen, projection" href="<%=request.getContextPath()%>/cola/cafe/theme/${theme}.css" />
	...
	<body marginwidth="0" marginheight="0" class="CF0802_bgImage CF0802_bgColor CF0802_bgImgPos CF0802_bgImgRepeat">
		...
		<div id="cafe_title_wrap" class="cafe_title_wrap draggable">
			<div class="cafetitle" id="div_cafe_title">
				<div id="titleArea" class="CF0102_bgHeight titleArea">
					...
					<div class="heightResizeBar CF0102_bgHeight" id="resizeBar">
		...
		<div class="menuArea">
			<div class="leftMenu">
				<%--
				<div class="menuEditor templateEditor"><div class="menu menuEditorLabel" onclick="javascript:cfTitleEditor.showTemplateEditor('CF0101', 525, 490, 1);"><util:message key="cf.prop.template"/></div></div>
				 --%>
				<div class="menuEditor cafeBgEditor"><div class="menu menuEditorLabel" onclick="javascript:cfTitleEditor.showTemplateEditor('CF0102', '312', 245, 1);"><util:message key="cf.prop.background"/></div></div>
				...
				<div class="menuEditor cafeUrlEditor"><div class="menu menuEditorLabel" onclick="javascript:cfTitleEditor.showCafeUrlEditor();"><util:message key="cf.title.cafeAddress"/></div></div>
				<%--
				<div class="menuEditor cafeTitleMenuEditor"><div class="menu menuEditorLabel" onclick="javascript:cfTitleEditor.showTemplateEditor('CF0105',500, 225, 1);"><util:message key="cf.prop.titleMenu"/></div></div>
			...
			<div class="rightMenu">
				<div class="menuController bgHeightController">
					<div class="menu menuControlLabel bgHeightLabel"><util:message key="ev.title.pageEditing.Height"/></div>
				...
				<div class="menuController gridController">
					...
					<label for="gridCheck" class="menu menuControlLabel"><util:message key="cf.prop.guide"/></label>
				</div>
				 --%>
				<div class="menuController resetController"><div class="menu menuControlLabel resetBtn" onclick="javascript:cfTitleEditor.reset();"><util:message key="cf.prop.backAgain"/></div></div>
			</div>
		</div>
