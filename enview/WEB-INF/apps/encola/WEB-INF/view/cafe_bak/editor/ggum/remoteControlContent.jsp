			...
			<c:if test="${edForm.ggum3rdMenu == 'user'}">
				...
				<div id="BackgroundUpload">
					<div id="backgroundUpImg">
						<a id="delPhoto" class="imgLink" onclick="cfGGum.getTplMngr().delPreviewImage();"><util:message key="ev.title.remove"/></a>
		...
		<c:if test="${edForm.ggum3rdMenu == 'user'}">
			...
			<div id="BackgroundUpload">
			  <div class="backgroundUpImg">
				<div id="backgroundUpImg">
				  <a id="delPhoto" class="imgLink" onclick="javascript:(new cube.controller.home.CafeMenuController()).onChangeBackgroundImage('');return false;" href="#"><util:message key="ev.title.remove"/></a>
