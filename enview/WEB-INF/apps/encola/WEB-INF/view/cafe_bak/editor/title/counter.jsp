...
<DL>
<DT>
<DIV class=priview_img><IMG id=previewUserImage src="http://cfile283.uf.daum.net/P100x100/183CB2374FB1DE51324BB0"> </DIV><A id=btnImageDelete onclick="(new cube.controller.title.BackgroundController()).onClickDeleteImage();"><util:message key="ev.title.remove"/></A> </DT>
<DD>
<UL>
<LI class=control>
...
<DIV style="BACKGROUND-IMAGE: none; WIDTH: 91px; DISPLAY: none" class=layer_btns><A class=btn_s_config onclick="(new cube.controller.title.MenuGroupController()).onClickMenuBtns(0, 'edit');">설정</A><A class=btn_s_remove onclick="(new cube.controller.title.MenuGroupController()).onClickMenuBtns(0, 'delete');"><util:message key="ev.title.remove"/></A></DIV></DIV>
...
<DIV style="BACKGROUND-IMAGE: none; WIDTH: 91px; HEIGHT: 33px" class=inner_layer>
<DIV style="BACKGROUND-IMAGE: none; BACKGROUND-COLOR: #fff; WIDTH: 91px; HEIGHT: 33px" class=inner_layer_blind></DIV></DIV>
<DIV style="BACKGROUND-IMAGE: none; WIDTH: 91px; DISPLAY: none" class=layer_btns><A class=btn_s_config onclick="(new cube.controller.title.MenuGroupController()).onClickMenuBtns(1, 'edit');">설정</A><A class=btn_s_remove onclick="(new cube.controller.title.MenuGroupController()).onClickMenuBtns(1, 'delete');"><util:message key="ev.title.remove"/></A></DIV></DIV>
...
<DIV style="BACKGROUND-IMAGE: none; WIDTH: 91px; HEIGHT: 33px" class=inner_layer>
<DIV style="BACKGROUND-IMAGE: none; BACKGROUND-COLOR: #fff; WIDTH: 91px; HEIGHT: 33px" class=inner_layer_blind></DIV></DIV>
<DIV style="BACKGROUND-IMAGE: none; WIDTH: 91px; DISPLAY: none" class=layer_btns><A class=btn_s_config onclick="(new cube.controller.title.MenuGroupController()).onClickMenuBtns(2, 'edit');">설정</A><A class=btn_s_remove onclick="(new cube.controller.title.MenuGroupController()).onClickMenuBtns(2, 'delete');"><util:message key="ev.title.remove"/></A></DIV></DIV>
...
<DIV style="BACKGROUND-IMAGE: none; WIDTH: 91px; HEIGHT: 33px" class=inner_layer>
<DIV style="BACKGROUND-IMAGE: none; BACKGROUND-COLOR: #fff; WIDTH: 91px; HEIGHT: 33px" class=inner_layer_blind></DIV></DIV>
<DIV style="BACKGROUND-IMAGE: none; WIDTH: 91px; DISPLAY: none" class=layer_btns><A class=btn_s_config onclick="(new cube.controller.title.MenuGroupController()).onClickMenuBtns(3, 'edit');">설정</A><A class=btn_s_remove onclick="(new cube.controller.title.MenuGroupController()).onClickMenuBtns(3, 'delete');"><util:message key="ev.title.remove"/></A></DIV></DIV>
...
<DIV style="BACKGROUND-IMAGE: none; WIDTH: 115px; DISPLAY: none" class=layer_btns><A class=btn_s_config onclick="(new cube.controller.title.MenuGroupController()).onClickMenuBtns(4, 'edit');">설정</A><A class=btn_s_remove onclick="(new cube.controller.title.MenuGroupController()).onClickMenuBtns(4, 'delete');"><util:message key="ev.title.remove"/></A></DIV></DIV>
