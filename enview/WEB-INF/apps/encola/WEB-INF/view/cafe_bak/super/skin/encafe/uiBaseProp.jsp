...
<c:if test="${suForm.view == 'cafe'}">
	<table class="adformpanel" width=100% cellpadding=0 cellspacing=0 border=0>
	  ...
	  <tr><td align=right colspan=4>
	    ...
	    <span class="btn_pack medium"><a href="javascript:superMngr.getBPMngr().doSave('cafe')"><util:message key="ev.title.save"/></a></span>
	  </td></tr>
	</table>
</c:if>	
<%--END::카페 설정탭--%>
...
<c:if test="${suForm.view == 'board.edit'}">
	<table class="adformpanel" width=100% cellpadding=0 cellspacing=0 border=0>
	  ...
	  <tr><td align=right colspan=4>
	    ...
	    <span class="btn_pack medium"><a href="javascript:superMngr.getBPMngr().doSave('board')"><util:message key="ev.title.save"/></a></span>
	  </td></tr>
	</table>
</c:if>	
<%--END::게시판 설정탭.하단 편집--%>
...
<c:if test="${suForm.view == 'mcd.edit'}">
	<table class="adformpanel" width=100% cellpadding=0 cellspacing=0 border=0>
	  ...
	  <tr><td height=1 colspan=4></td></tr>
	  <tr height=30>
	    <td class="adformlabeldark" align="right" style="padding:0px 10px 0px 10px"><util:message key="eb.prop.updUserId"/></td>
	    <td class="adformfield">
		  <c:out value="${mcdVO.updUserId}"/>
	    </td>
	    <td class="adformlabel" align="right" style="padding:0px 10px 0px 10px"><util:message key="eb.title.updateDate"/></td>
	    <td class="adformfielddarklast">
	  ...
	  <tr><td align=right colspan=4>
	    ...
	    <span class="btn_pack medium"><a href="javascript:superMngr.getBPMngr().doSave('mcd')"><util:message key="ev.title.save"/></a></span>
	  </td></tr>
	</table>
</c:if>	
<%--END::마일리지 설정탭.하단 편집--%>
	  ...
	  <table width=98% cellpadding=0 cellspacing=0 border=0>
	    ...
	    <tr>
		  <td align=right colspan=2>
			<span class="btn_pack medium"><a href="javascript:superMngr.getBPMngr().doSave('mgrd')"><util:message key="ev.title.save"/></a></span>
			<c:if test="${suForm.act == 'upd'}">
				<span class="btn_pack medium"><a href="javascript:superMngr.getBPMngr().doMGrdDelete()"><util:message key="ev.title.remove"/></a></span>
			</c:if>
		   </td>
	    </tr>
	  </table>
