...
<dl>
<dt><h2 class="cafeformsubject">가입 제한 조건 설정</h2></dt>
<dd>
  <table cellpadding=0 cellspacing=0 border=0 width='100%'>
	<tr><td colspan="2" height="2" width="100%" class="cafeformlimit"></td></tr>
	<tr>
	  <td width="20%" class="cafeformlabel"><img src="<%=request.getContextPath()%>/cola/cafe/images/sysop/encafe/tb_icon.gif" width="5" height="5" align="absmiddle">성별</td>
	  <td class="cafeformfieldlast" align="left">
	    <c:forEach items="${sexList}" var="sex">
	      <input type="radio" id="reg_limitSex" name="reg_limitSex" value="<c:out value="${sex.code}"/>" <c:if test="${limitVO.limitSex==sex.code}">checked</c:if>
	...
	<tr>
	  <td width="20%" class="cafeformlabel"><img src="<%=request.getContextPath()%>/cola/cafe/images/sysop/encafe/tb_icon.gif" width="5" height="5" align="absmiddle">나이</td>
	  <td class="cafeformfieldlast" align="left">
	...
	<tr>
	  <td width="20%" class="cafeformlabel"><img src="<%=request.getContextPath()%>/cola/cafe/images/sysop/encafe/tb_icon.gif" width="5" height="5" align="absmiddle">지역</td>
	  <td class="cafeformfieldlast" align="left">
	...
	<tr>
	  <td width="20%" class="cafeformlabel"><img src="<%=request.getContextPath()%>/cola/cafe/images/sysop/encafe/tb_icon.gif" width="5" height="5" align="absmiddle">학과/전공</td>
	  <td class="cafeformfieldlast" align="left">
	...
	<tr>
	  <td width="20%" class="cafeformlabel"><img src="<%=request.getContextPath()%>/cola/cafe/images/sysop/encafe/tb_icon.gif" width="5" height="5" align="absmiddle">학부</td>
	  <td class="cafeformfieldlast" align="left">
	...
	<tr>
	  <td width="20%" class="cafeformlabel"><img src="<%=request.getContextPath()%>/cola/cafe/images/sysop/encafe/tb_icon.gif" width="5" height="5" align="absmiddle">조직</td>
	  <td class="cafeformfieldlast" align="left">
...
<dt><h2 class="cafeformsubject">가입 퀴즈/설문 설정</h2></dt>
<dd>
  <table cellpadding=0 cellspacing=0 border=0 width='100%'>
	<tr><td colspan="2" height="2" width="100%" class="cafeformlimit"></td></tr>
	<tr>
	  <td width="20%" class="cafeformlabel"><img src="<%=request.getContextPath()%>/cola/cafe/images/sysop/encafe/tb_icon.gif" width="5" height="5" align="absmiddle">가입 퀴즈</td>
	  <td class="cafeformfieldlast" align="left">
	...
	<tr>
	  <td width="20%" class="cafeformlabel"><img src="<%=request.getContextPath()%>/cola/cafe/images/sysop/encafe/tb_icon.gif" width="5" height="5" align="absmiddle">가입 설문</td>
	  <td class="cafeformfieldlast" align="left">
	    <c:forEach items="${useList}" var="use">
...
<dt><h2 class="cafeformsubject">신규 가입 제한 기간 설정</h2></dt>
<dd>
  <table cellpadding=0 cellspacing=0 border=0 width='100%'>
	<tr><td colspan="2" height="2" width="100%" class="cafeformlimit"></td></tr>
	<tr height="30px">
	  <td width="20%" class="cafeformlabel"><img src="<%=request.getContextPath()%>/cola/cafe/images/sysop/encafe/tb_icon.gif" width="5" height="5" align="absmiddle">가입 제한 기간</td>
	  <td class="cafeformfieldlast" align="left">
	    <c:forEach items="${termList}" var="term">
		  ...
		  <c:if test="${term.code=='Y'}"><%--가입신청을 안 받는 경우--%>
            ...
            <img align="absmiddle" src="<%=request.getContextPath()%>/cola/cafe/images/sysop/encafe/calendar.gif" onclick="displayCalendar(new Date(), 'reg_denyBgnYmd', event)"/>
			&nbsp;~&nbsp;
            <input type="text" id="reg_denyEndYmd" name="reg_denyEndYmd" value="<c:out value="${limitVO.denyEndYmdF}"/>"  style="width:70" readonly="true">
            <img align="absmiddle" src="<%=request.getContextPath()%>/cola/cafe/images/sysop/encafe/calendar.gif" onclick="displayCalendar(new Date(), 'reg_denyEndYmd', event)"/>
		  </c:if>
		</c:forEach>
	  </td>
	</tr>
...
<div class="cafecontrolpanel">
	<span class="btn_pack small">
		<a href="#" onclick="javascript:cfOp.regInfo.setCmntLimit()">저 장</a>
	</span>
  </div>
</div>
