	  ...
	  <table width="100%">
	    <tr>
		  ...
		  <td align="right">
			...
			<img src="<%=request.getContextPath()%>/cola/cafe/images/sysop/encafe/btn_search.gif" hspace="2" align="absmiddle" style="cursor:hand" onclick="cfOp.regMmbr.search('gup_srchForm')"/>
		    ...
		    <td colspan="100">
			  ...
			  <span style="margin-left:10px">
				...
				<span class="btn_pack small">
					<a href="#" onclick="javascript:cfOp.regMmbr.changeGrade('gup')">변경</a>
				</span>
			  </span>
			  <span style="margin-left:30px">
			  	 <span class="btn_pack small">
					<a href="#" onclick="javascript:cfOp.regMmbr.checkChangeState('gup','40')">활동중지</a>
				</span>
				 <span class="btn_pack small">
					<a href="#" onclick="javascript:cfOp.regMmbr.checkChangeState('gup','51')">강제탈퇴</a>
				</span>
			  </span>
			</td>
		  </tr>
