	  ...
	  <table width="100%">
	    <tr>
		  <td align="right">
			...
			<img src="<%=request.getContextPath()%>/cola/cafe/images/sysop/encafe/btn_search.gif" hspace="2" align="absmiddle" style="cursor:hand" onclick="cfOp.rsgnMmbr.search('rsgn_srchForm')"/>
		    ...
		    <td colspan="100">
			  ...
			  <span style="margin-left:10px">
			  	 <span class="btn_pack small">
					<a href="#" onclick="javascript:cfOp.rsgnMmbr.changeState('rsgn','40')">활동중지 해제</a>
				</span>
				 <span class="btn_pack small">
					<a href="#" onclick="javascript:cfOp.rsgnMmbr.changeState('rsgn','51')">강제탈퇴 해제</a>
				</span>
			  </span>
