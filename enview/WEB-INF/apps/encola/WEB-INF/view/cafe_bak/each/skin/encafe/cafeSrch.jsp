...
<div class="cafe_srch_wrap" id="cafe_srch_wrap">
	<div class="cafe_srch" id="div_cafe_srch">
		<input id="CF0601_srchKey" class="CF0601_bgColor CF0601_brdrColor CF0601_brdrStyle CF0601_fontColor srch_field" type="text" onkeyup="javascript:cfSrch.search();"/>
		<input id="srchBtn" title="검색" type="button" alt="검색" class="CF0601_srchBtn srchBtn" onclick="javascript:cfSrch.search();"/>
	</div>
