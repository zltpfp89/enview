...
<%@ page import="com.saltware.enview.EnviewActions" %>
<%@ page import="com.saltware.enview.ui.Jetui" %>
<%@ page import="com.saltware.enview.ui.Toolbar" %>
<%@ page import="com.saltware.enview.request.RequestContext" %>
<%@ page import="com.saltware.enview.om.page.ContentFragment" %>
<%@ page import="com.saltware.enview.om.page.ContentPage" %>
<%@ page import="com.saltware.enview.portlets.layout.ColumnLayout" %>
<%@ page import="com.saltware.enview.decoration.DecoratorAction" %>
<%@ page import="com.saltware.enview.PortalReservedParameters" %>
<%@ page import="com.saltware.enview.administration.PortalConfiguration" %>
<%@ page import="com.saltware.enview.administration.PortalConfigurationConstants" %>
...
<link rel="shortcut icon" href="<%=baseUrl%>images/enview.jpg" type="image/x-icon" />
...
var JETUI_YUI = {
  ...
  modules: {
    'jetui-portal': { fullpath: "<%=request.getContextPath()%>/javascript/enview/jetui/jetui-portal.js" }
  }
}; // ({classNamePrefix: 'jet'})
</script>
...
<%if (request.getUserPrincipal() != null) {%>
<span class="layout-statusarea"><b><%=userNameGiven%> <%=userNameFamily%></b> | <a href="<%=request.getContextPath()%>/login/logout?com.saltware.enview.login.destination=<%=request.getContextPath()%>/ui">Log out</a></span>
<% } %>
...
<%      
            ...
            for (ContentFragment fragment : collections)
            {
                ...
                if (state == null || !state.equals(EnviewActions.DETACH))
                {
  ...
  <div class="portlet <%=pageDec%>">
    <div class="PTitle">
      ...
      <div class="PActionBar">
        <span style='cursor: pointer; z-index: 1000;' id='enview-close-XXX' title="close" class="portlet-action-close"><img src="<%=request.getContextPath()%>/decorations/portlet/enview/images/close.gif" alt="Close" border="0" /></span>
        <span style='cursor: pointer; z-index: 1000;' id='enview-detach-XXX' title="detach" class="portlet-action-detach"><img src="<%=request.getContextPath()%>/decorations/images/detach.gif" alt="Detach" border="0" id='enview-detach-img-XXX'/></span>              
      </div>
    </div>
    <div class="PContentBorder">
