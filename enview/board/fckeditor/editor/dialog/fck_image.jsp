...
//			UpdatePreview();
		...
		function uploadCafeGateImage(fn, fm, fs, halign, valign) {
			var fileUrl = FCKConfig.BasePath.substring(FCKConfig.BasePath.indexOf('://')+3);
			fileUrl = fileUrl.substring(fileUrl.indexOf('/'));
			fileUrl = fileUrl.substring(0, fileUrl.lastIndexOf('/board/fckeditor')); // 여기까지 하면 fileUrl에 contextPath 값이 들어가 있게 된다.
