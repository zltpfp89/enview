...
e.css&&(a+=" "+e.css),e.title&&(n.title=e.title),n.className=a;var s=t.posFromDate(e.start_date);if(n.style.left=s+"px",n.style.height=Math.max(t._y_from_ind(t._order.length),0)+"px",e.end_date){var r=t.posFromDate(e.end_date);n.style.width=Math.max(r-s,0)+"px"}return e.text&&(n.innerHTML="<div class='gantt_marker_content' >"+e.text+"</div>"),n}}var i=document.createElement("div");i.className="gantt_marker_area",t.$task_data.appendChild(i),t.$marker_area=i,t._markerRenderer=t._task_renderer("markers",e,t.$marker_area,null);
}),t.attachEvent("onDataRender",function(){t.renderMarkers()}),t.getMarker=function(t){return this._markers?this._markers[t]:null},t.addMarker=function(e){return e.id=e.id||t.uid(),this._markers[e.id]=e,e.id},t.deleteMarker=function(t){return this._markers&&this._markers[t]?(delete this._markers[t],!0):!1},t.updateMarker=function(t){this._markerRenderer&&this._markerRenderer.render_item(t)},t.renderMarkers=function(){if(!this._markers)return!1;if(!this._markerRenderer)return!1;var t=[];for(var e in this._markers)t.push(this._markers[e]);
