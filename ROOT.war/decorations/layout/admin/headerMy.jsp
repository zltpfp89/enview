				...
				<c:if test="${isMyPage == true}">
					...
					<div class="menu-title" onmouseover2="onMouseOverMenu('mypage_title')" onmouseout2="onMouseOutMenu('mypage_title')">
						...
						<span id="mypage_title">
							...
							<a href="javascript:portalMyPageEditor.setDefaultPage('${pageContext.request.contextPath}/')"><img src="${cPath}/decorations/layout/images/home.gif" align="absmiddle" alt="<util:message key='ev.title.mypage.grouppage'/>" title="<util:message key='ev.title.mypage.grouppage'/>"></a>
							<a href="javascript:portalMyPageEditor.doRemoveAll('${pageContext.request.contextPath}/')"><img src="${cPath}/decorations/layout/images/icon_del.gif" align="absmiddle" alt="<util:message key='ev.title.mypage.reset'/>" title="<util:message key='ev.title.mypage.reset'/>"></a>
						</span>
					</div>
					<ul id="mypage">
						...
						<li id="mymenu<c:out value="${myPage.pageId}"/>" onmouseover="onMouseOverMenu('mymenuButton<c:out value="${myPage.pageId}"/>')" onmouseout="onMouseOutMenu('mymenuButton<c:out value="${myPage.pageId}"/>')">
							...
							<span id="mymenuButton<c:out value="${myPage.pageId}"/>" style="display:none;"> 
								...
								<a href="javascript:portalMyPageEditor.setDefaultMyPage('${pageContext.request.contextPath}/', '<c:out value="${myPage.pageId}"/>', '<c:out value="${myPage.path}"/>')"><img src="${cPath}/decorations/layout/images/home.gif" align="absmiddle" alt="<util:message key='ev.title.mypage.homepage'/>" title="<util:message key='ev.title.mypage.homepage'/>"></a>
							</span>
						</li>
						</c:forEach>
					</ul>
