		...
		<div id="cafe_main" class="cafe_main">
			<div id="main_navigation" class="main_navigation">
				<div class="navi_menus">
					...
					<div class="navi_menu" onclick="javascript:cfEach.go2Home('');">카페</div>
					<div class="navi_seperater">|</div>
					<div class="navi_menu">
						<div class="navi_menu" id="favorLink" onclick="javascript:cfEach.showFavorCafe()">자주가는카페</div>
						<div id="favorCafeDiv" class="favorCafeDiv CF0802_bgColor CF0802_extraBrdrColor">
							...
							<ul class="favorCafeList">
								<li class="favorCafeControl" onclick="javascript:cfEach.go2Home('mine.favor')">- 전체보기</li>
								<li class="favorCafeControl" onclick="javascript:cfEach.go2Home('mine.favorEdit')">- 편집</li>
							</ul>
