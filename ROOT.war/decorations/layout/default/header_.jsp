...
<%
	//System.out.println("######### rootSite=" + rootSite);
	Collection componentAreas = codes.getCodes("PT", "102", 1, true);
...
<%	if( isLogin ) { %>
				<table width="160" border="0" cellspacing="0" cellpadding="3">
				  ...
				  <tr>
					<td width="61" height="25"><a href="<%=site.getLogoutUrl()%>"><img src="${themePath}/images/btn_logout.gif" width="61" height="16" alt="Logout" /></a></td>
				  </tr>
				  <tr>
...
<% } else { %>
				...
				<table width="160" border="0" cellspacing="0" cellpadding="3">
				  <tr> 
					<td width="80" height="23" align="right" style="color:#fff"><util:message key="pt.ev.property.userId"/>&nbsp;&nbsp;&nbsp;</td> 
				  ...
				  <tr> 
					<td width="80" height="23"  align="right" style="color:#fff"><util:message key="pt.ev.property.password"/>&nbsp;&nbsp;&nbsp;</td>
					<td width="90" height="23"> 
...
<%				
	...
	for(int cnt=0; it.hasNext(); cnt++, tabordercnt++) {
		...
		if( element.isHidden() == false ) {
			...
			String linkName = element.getName();
%>
					<span><a href="<%=linkUrl%>" target="<%=linkTarget%>"><img src="${themePath}/images/menu/<%=linkName%>.gif" height="26" alt="<%=linkTitle%>" /></a></span>
<%
		}
	} %>
	<%--
...
--%>				
				...
				<td width="185" height="35">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						  <td align="right">
							<a href="http://enview.saltware.co.kr"><img src="${themePath}/images/btn_home.gif" width="54" align="absmiddle" alt="Enview Home" /></a>
<%	if( isLogin ) { %>						  
							<a href="<%=userDir%>"><img src="${themePath}/images/btn_mypage.gif" width="54" align="absmiddle" alt="Mypage" /></a>
							<a href="<%=groupDir%>"><img src="${themePath}/images/btn_mypage.gif" width="54" align="absmiddle" alt="Grouppage" /></a> 
<%	} %>
...
<%	} %>
      ...
      <tr>
        <td id="EnviewContentArea" width="755" height="250" align="center" valign="top">
