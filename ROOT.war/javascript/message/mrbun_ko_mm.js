...
enview.portal.MessageResource.prototype =
{
	...
	init : function()
	{
		...
		this.messageRes.put("mm.error.invalid.referer.0", "유효한 레퍼러가 아닙니다\u003Cbr\u003E");
		this.messageRes.put("mm.info.cant.special.0", "잘못된 문자가 있습니다. 특수문자는 입력할수 없습니다.");
		this.messageRes.put("mm.error.sql.badIntegrity.0", "무결성 제약 조건에 위배됩니다\u003Cbr\u003E");
		...
		this.messageRes.put("mm.info.select.multi.0", "{0}개 선택해주십시오");
