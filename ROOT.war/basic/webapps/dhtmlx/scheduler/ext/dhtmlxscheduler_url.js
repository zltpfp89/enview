...
if(a){a=!1;var l=e._get_url_nav();if(l.event)try{if(e.getEvent(l.event))return t(l.event),!1;var c=e.attachEvent("onXLE",function(){t(l.event),e.detachEvent(c)})}catch(h){}if(l.date||l.mode){try{this.setCurrentView(l.date?n(l.date):null,l.mode||null)}catch(h){this.setCurrentView(l.date?n(l.date):null,d)}return!1}}var u=["date="+i(_||s),"mode="+(d||o)];r&&u.push("event="+r);var p="#"+u.join(",");return document.location.hash=p,!0})})});
