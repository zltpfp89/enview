...
dojo.declare("dojo.widget.HtmlWidget", dojo.widget.DomWidget, {templateCssPath: null,
templatePath: null,
lang: "",
toggle: "plain",
toggleDuration: 150,
initialize: function(args, frag){},
postMixInProperties: function(args, frag){if(this.lang === ""){this.lang = null;}
this.toggleObj =
...
destroyRendering: function(finalize){try{if(this.bgIframe){this.bgIframe.remove();
...
isShowing: function(){return dojo.html.isShowing(this.domNode);
},
...
onResized: function(){dojo.lang.forEach(this.children, function(child){ if(child.checkSize){child.checkSize();}});
}});
