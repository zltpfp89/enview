...
(function(){var map = {html: {"accordioncontainer": "dojo.widget.AccordionContainer",
...
dojo.addDojoNamespaceMapping = function(shortName, packageName){map[shortName]=packageName;
};
function dojoNamespaceResolver(name, domain){if(!domain){ domain="html"; }
