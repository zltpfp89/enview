function initialize_ev(parentResource) {
	...
	parentResource.setMessage("ev.info.success.move.1", "Successfully moved");
	...
	parentResource.setMessage("ev.info.title.notice.1", "notice");
	...
	parentResource.setMessage("ev.info.message.mysetting.notvalue.1", "There is no input value. Please check.");
	parentResource.setMessage("ev.info.message.kaist.board.1", "Board");
	parentResource.setMessage("ev.info.message.kaist.notice.1", "Notice");
	parentResource.setMessage("ev.info.message.kaist.etc.1", "Etc");
