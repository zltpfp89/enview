...
<%@page import="com.saltware.enview.headerresource.HeaderResourceFactory"%>
<%@page import="com.saltware.enview.headerresource.HeaderResource"%>
<%@page import="com.saltware.enview.request.RequestContext"%>
<%@page import="com.saltware.enview.portlets.layout.LayoutCoordinate"%>
<%@page import="com.saltware.enview.decoration.LayoutDecoration"%>
<%@page import="com.saltware.enview.decoration.DecorationFactory"%>
<%@page import="com.saltware.enview.om.page.ContentFragment"%>
<%@page import="com.saltware.enview.util.Path"%>
...
<portlet:defineObjects/>
  ...
  <%!  
      private static final Log log = LogFactory.getLog("com.saltware.enview.portlets.layout.jsp_templates");
  ...
  <%
      ...
      //Enview Power Tool
      EnviewPowerTool _jpt = (EnviewPowerTool) renderRequest.getAttribute(PortalReservedParameters.ENVIEW_POWER_TOOL_REQ_ATTRIBUTE);
      pageContext.setAttribute("jpt", _jpt, REQ_SCOPE);
    
      //Enview Request Context
      ...
      PortalSiteRequestContext _psrc = (PortalSiteRequestContext) renderRequest.getAttribute("com.saltware.enview.portalsite.PortalSiteRequestContext");
      pageContext.setAttribute("psrc", _psrc, REQ_SCOPE);

      //Get the resourceHeaderFactory
      HeaderResourceFactory headerResourceFactory = (HeaderResourceFactory) _jpt.getComponent("com.saltware.enview.headerresource.HeaderResourceFactory");
  ...
  <%
      ...
      // TODO got to move ColumnLayout from layout-portlets out! Enview webapp cannot see it!
