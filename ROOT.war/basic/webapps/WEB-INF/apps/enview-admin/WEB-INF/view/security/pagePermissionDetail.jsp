					...
					<div id="propertyTabs">
						<div id="PagePermissionManager_DetailTabPage">
							<div class="webformpanel" style="width:100%;">
								...
								<tr>
									<td align="right">  
										<img src="<%=request.getContextPath()%>/admin/images/button/btn_create.gif" hspace="2" style="cursor:hand" onclick="javascript:aPagePermissionManager.doCreate()">
										<img src="<%=request.getContextPath()%>/admin/images/button/btn_save.gif" hspace="2" style="cursor:hand" onclick="javascript:aPagePermissionManager.doUpdate(true)">
									</td>
								</tr>
								</table>
								</form>
