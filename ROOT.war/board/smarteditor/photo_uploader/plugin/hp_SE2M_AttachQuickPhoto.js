...
nhn.husky.SE2M_AttachQuickPhoto = jindo.$Class({		
	...
	makePopupURL : function(){
		...
		var param =  (window.parent.cfGate?'cafe=gate':'');
		param += (window.parent.ebEdit?'&tns='+window.parent.ebEdit.thumbSize+'&boardId='+window.parent.ebEdit.boardRid:'');
		param += (window.parent.document.getElementById('cmntId')?'&cmntId='+window.parent.document.getElementById('cmntId').value:'');
		
		var sPopupUrl = "./photo_uploader/popup/photo_uploader.jsp?"+param;
		//var sPopupUrl = "./photo_uploader/popup/photo_uploader.jsp?"+(window.parent.ebEdit?'&tns='+window.parent.ebEdit.thumbSize+'&boardId='+window.parent.ebEdit.boardRid:'')+(window.parent.document.getElementById('cmntId')?'&cmntId='+window.parent.document.getElementById('cmntId').value:'');
		return sPopupUrl;
	},
