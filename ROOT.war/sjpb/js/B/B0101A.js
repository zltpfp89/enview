...
function callBackSelectIncidentSuccess(data){
	...
	spHtml.append('		   <td class="L">남부지검</td>');
	spHtml.append('	   </tr>                                                                                                                                                                                                                                             ');	
	...
	$.each(b0101VOMap.incCriMbVOList, function(i, incCriMb) {
		...
		if(incCriMb.criLvCd == "01"){	//담당수사관
			spHtml.append('			<label for="criMbNmKorMain"></label><input type="text" class="w100per" id="criMbNmKorMain" name="criMbNmKorMain" value="'+incCriMb.nmKor+'" data-name="criMb" data-criMbId="'+incCriMb.criMbId+'" data-criTmId="'+incCriMb.criTmId+'" disabled="true" data-always="y"/><a class="btn_search" id="criMbNmKorMainBtn" name="criMbNmKorMainBtn" href="javascript:setCriMbNmKorMain();" style="display:none;" data-always="y"><img src="/sjpb/images/btn_search.png" alt="search" /></a>             ');
			isIncCriMbMain = true;
...
//유저와 상태에 따른 탭 활성화 처리
function handleTab(){
	var scriStatCd = b0101VOMap.criStatCd;
...
function callBackInsertIncMastViewSuccess(data){
	...
	spHtml.append('		   <th class="C">착수일시</th>                                                                                                                                                                                                                      ');
	spHtml.append('		   <td class="L"><input type="text" class="w100per calendar datepicker" name="beDt" id="beDt" value="" title="착수일시" readonly /></td>');
	spHtml.append('	   </tr>                                                                                                                                                                                                                                             ');
	spHtml.append('	   <tr>                                                                                                                                                                                                                                             ');
	spHtml.append('		   <th class="C">처리일시</th>                                                                                                                                                                                                                      ');
	spHtml.append('		   <td class="L"><input type="text" class="w100per calendar datepicker" name="proDt" id="proDt" value="" title="처리일시" readonly /></td>');
	spHtml.append('		   <th class="C">수리일시</th>                                                                                                                                                                                                                      ');
	spHtml.append('		   <td class="L"><input type="text" class="w100per calendar datepicker" name="acptDt" id="acptDt" value="" title="수리일시" readonly /></td>');
	
	spHtml.append('	   </tr>                                                                                                                                                                                                                                             ');	
	
	spHtml.append('	   <tr>                                                                                                                                                                                                                                             ');
	spHtml.append('		   <th class="C">접수일시</th>                                                                                                                                                                                                                      ');
	spHtml.append('		   <td class="L"><input type="text" class="w100per calendar datepicker" name="rcptDt" id="rcptDt" value="" title="접수일시" readonly />');
	spHtml.append('		   <th class="C">이첩기관</th>                                                                                                                                                                                                                      ');
	spHtml.append('		   <td class="L">남부지검</td>');
...
//	spHtml.append('   </tbody>                                                                                                                                                                                                                                          ');
	...
	spHtml.append('			   <label for="incText_0"></label><input type="text" class="w100per" id="incText_0" name="incText" />                                                                                                                                                    ');
	spHtml.append('		   </td>                                                                                                                                                                                                                                        ');
	spHtml.append('	   </tr>                                                                                                                                                                                                                                             ');
	spHtml.append('	   <tr>                                                                                                                                                                                                                                             ');
	spHtml.append('		   <th class="C">처리결과</th>                                                                                                                                                                                                                       ');
	spHtml.append('		   <td class="C" colspan="3">                                                                                                                                                                                                                       ');
	spHtml.append('			   <label for="proRst_0"></label><input type="text" class="w100per" id="proRst_0" name="proRst" />                                                                                                                                                    ');
	spHtml.append('		   </td>                                                                                                                                                                                                                                        ');	
	spHtml.append('	   </tr>                                                                                                                                                                                                                                             ');
	...
	spHtml.append('<div class="btnArea" id="criArea02">                                                                                                                                                                                                                                ');
	spHtml.append('   <div class="r_btn" id="btnArea_EditButtons"><a href="javascript:saveIncMast();self.close();" class="btn_white"><span>임시저장</span></a><a href="javascript:insertIncMast();self.close();" class="btn_blue"><span>사건등록</span></a></div>                                                                                                                     ');
	spHtml.append('</div>                                                                                                                                                                                                                                               ');
...
//워크플로우 상태이행처리
function executeTask2(callbackFunction){
	
	goAjax("/sjpb/B/executeTask.face", b0101TKMap, function(data){ callBackexecuteTaskSuccess2(data, callbackFunction)});
}
...
//워크플로우 상태이행처리 콜백처리
function callBackexecuteTaskSuccess2(data, callbackFunction) {
	//console.log(JSON.stringify(data));
	alert("정상적으로 처리되었습니다.");
...
function renderSpHtml(data, incSpVOList, subSpTitle){
	...
	$.each(incSpVOList, function(i, incSpVO) {
		...
		spHtml.append('		   <th class="C">내사할 사항</th>                                                                                                                                                                                                                       ');
		spHtml.append('		   <td class="L" colspan="3">                                                                                                                                                                                                                               ');
		spHtml.append('			   <label for="incText_'+countSp+'_0"></label><input type="text" class="w100per" id="incText_'+countSp+'_0" name="incText" value="'+incSpVO.incText+'"/>                                                                                                                                                    ');		
		spHtml.append('	  	   </td>                                                                                                                                                                                                                                             ');
		spHtml.append('	   </tr>                                                                                                                                                                                                                                             ');	
		spHtml.append('	   <tr>                                                                                                                                                                                                                                             ');
		spHtml.append('		   <th class="C">처리 결과</th>                                                                                                                                                                                                                       ');
		spHtml.append('		   <td class="L" colspan="3">                                                                                                                                                                                                                               ');
		spHtml.append('			   <label for="proRst_'+countSp+'_0"></label><input type="text" class="w100per" id="proRst_'+countSp+'_0" name="proRst" value="'+incSpVO.proRst+'"/>                                                                                                                                                    ');		
		spHtml.append('	  	   </td>                                                                                                                                                                                                                                             ');
		spHtml.append('	   </tr>                                                                                                                                                                                                                                             ');
...
function syncincCriMbList(paramMap){
	...
	incCriMbVOMain.criTmId = $("input[name=criMbNmKorMain]").attr("data-criTmId");
	paramMap.criTmId = incCriMbVOMain.criTmId;
...
function syncB0101VOMap() {
	...
	b0101VOMap.rcptDt = $("#rcptDt").val();	//접수일자
...
function callBackSetCriMbSuccess(data, type){
	...
	if(type == "1"){
		...
		$("#criMbNmKorMain").attr("data-criTmId", criTmIdTmp);
		//이름 셋팅 
