...
$(document).ready(function(){
	...
	//페이지 진입시 인사현황 직렬/직급별현황 출력시 성공함수 호출
	goAjaxDefault("/sjpb/J/J0401List.face",map,callBackFn_selectListSuccess);
	var date = new Date();
...
function callBackFn_selectListSuccess(data){
	var QCELLProp = {
			...
			"selectmode": "row",
			"columns" : [ 
				{ width : '6%', key : 'sort', title : ['구분','구분'], sort : true, move : false, resize : false, styleclassname : { data : 'aligncenter fontsize17' } }, 
