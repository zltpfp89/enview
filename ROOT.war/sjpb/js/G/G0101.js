...
//	initoffiSchdMngVOMap();
	...
	contentsArea.find("textarea").val("");
...
function handleUI(type){
	...
	if(isNull(g0101VOMap.forsInveReqSiNum)){
		...
		reqbkBtnHtml.append('<a href="javascript:insertReqBk();" class="btn_light_blue save"><span>요청</span></a>');
	...
	//3. 요청자가 아닐경우, 조회만 가능 
		...
		if(SJPBRole.getDgtFrsRoleYn()){
			...
			if(g0101VOMap.forsInveReqStatCd == "01"){
				reqbkBtnHtml.append('<a href="javascript:fixReqBk();" class="btn_light_blue save"><span>확정</span></a>');
			}
			
			reqbkBtnHtml.append('<a href="javascript:updateReqBk();" class="btn_light_blue_line appointed"><span>수정</span></a>');
	...
	if(SJPBRole.getDgtFrsRoleYn()){
		...
		if(g0101VOMap.forsInveOffiSchdMngVO != null && !isNull(g0101VOMap.forsInveOffiSchdMngVO.schdMngSiNum)){	
			...
			if($("#userId").val() == g0101VOMap.forsInveOffiSchdMngVO.forsCriOffi){
				offischdmngBtnHtml.append('<a href="javascript:updateOffiSchdMng();" class="btn_light_blue_line appointed"><span>수정</span></a>');
				offischdmngBtnHtml.append('<a href="javascript:deleteOffiSchdMng();" class="btn_white"><span>취소</span></a>');
			}
		
		//신규 등록일 경우, 요청 버튼 노출 
		}else{
			offischdmngBtnHtml.append('<a href="javascript:insertOffiSchdMng();" class="btn_light_blue save"><span>저장</span></a>');
