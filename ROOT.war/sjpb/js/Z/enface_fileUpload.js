...
SjpbEditManager.prototype = {	
	...
	init : function() {
		...
		sjpbFile.vaultUploader = new dhtmlXVaultObject({
		   ...
		   // uploadUrl:  "/dhtmlx/vault/handler/enboard_handler.jsp?boardId=" + sjpbFile.boardId + "&subId=sub01",           // html4/html5 upload url
			uploadUrl:  "/comm/AddOnfileMngr?cmd=upload&rcptNum="+sjpbFile.rcptNum+"&subId=sub01",           // html4/html5 upload url
			autoStart : false,
			buttonUpload : false,
			buttonClear : true
		});
