...
var selectIncSearchList = function(){	
	//검색조건
	c0301SCMap.criTmIdSC = $('#criTmIdSC').val();
	if ($('#beDtFromSC').val() != "") {
		c0301SCMap.beDtFromSC = $('#beDtFromSC').val() + " 00:00:00";
	}
	if ($('#beDtToSC').val() != "") {
		c0301SCMap.beDtToSC = $('#beDtToSC').val() + " 23:59:59";
	}
	
	goAjax("/sjpb/C/selectIncSearchList.face", c0301SCMap, callBackSelectIncSearchListSuccess,true)
