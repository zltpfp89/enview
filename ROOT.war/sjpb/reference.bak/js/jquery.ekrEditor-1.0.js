...
(function($){
	...
	$.fn.ekrEditor = function (opts) {
		return this.each(function () {
			...
			var mergeOpts = $.extend(true, {}, $.fn.ekrEditor.defaultOpts, opts);
	...
	function log() {
	    if (!$.fn.ekrEditor.debug) {
	        return;
	    }
	    var msg = '[jquery.ekrEditor] ' + Array.prototype.join.call(arguments,'');
