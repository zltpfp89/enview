...
//출력 
function prnData(){
	goAjax("/sjpb/M/M0124selectList.face", m0124SCMap, callBackPrnDataSuccess);
}
...
function callBackPrnDataSuccess(data){
	...
	m0124RTMap.rexdataset = data.qCell;
...
function selectList(selectPkNum){
	...
	goAjax("/sjpb/M/M0124selectList.face", m0124SCMap, function (data){callBackSelectListSuccess(data, selectPkNum)});
}
...
function showList(data, selectPkNum){
	...
	var QCELLProp = {
            ...
            "columns"	: [
            	...
            	{width: '10%',	key: 'apprDocNum',				title: ['허가서 번호','허가서 번호'],		sort:true, move:true, resize: true, styleclassname: {data: 'aligncenter fontsize13'}},
            	{width: '10%',	key: 'spNm',			title: ['성명','성명'],		sort:true, move:true, resize: true, styleclassname: {data: 'aligncenter fontsize13'}},
            	{width: '10%',	key: 'cmctCnfmExecTrgt',			title: ['통신사실 확인자료제공 요청집행','대상'],		sort:true, move:true, resize: true, styleclassname: {data: 'aligncenter fontsize13'}},
            	{width: '10%',	key: 'cmctCnfmExecType',	title: ['통신사실 확인자료제공 요청집행','종류'],		sort:true, move:true, resize: true, styleclassname: {data: 'aligncenter fontsize13'}},
            	{width: '20%',	key: 'cmctCnfmExecRnge',			title: ['통신사실 확인자료제공 요청집행','범위'], options:{limit:'number'},		sort:true, move:true, resize: true, styleclassname: {data: 'aligncenter fontsize13'}},
            	{width: '10%',	key: 'cmctCnfmExecDt',			title: ['집행일시','집행일시'], options:{limit:'number'},		sort:true, move:true, resize: true, styleclassname: {data: 'aligncenter fontsize13'}},
            	{width: '15%',	key: 'cmctCnfmComn',				title: ['비고','비고'],		sort:true, move:true, resize: true, styleclassname: {data: 'aligncenter fontsize13'}},	                	
...
function handleUI(){
	...
	//수정일 경우, 수정 버튼 노출 
		...
		if($("#userId").val() == m0124VOMap.regUserId){
			areaSetWrite($("#contentsArea"));
