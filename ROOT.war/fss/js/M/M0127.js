...
//출력 
function prnData(){
	goAjax("/sjpb/M/M0127selectList.face", m0127SCMap, callBackPrnDataSuccess);
}
...
function callBackPrnDataSuccess(data){
	...
	m0127RTMap.rexdataset = data.qCell;
...
//	m0127SCMap.regUserNmSc = getFieldValue($("#regUserNmSc"));
	...
	goAjax("/sjpb/M/M0127selectList.face", m0127SCMap, function (data){callBackSelectListSuccess(data, selectPkNum)});
}
...
function showList(data, selectPkNum){
	...
	var QCELLProp = {
            ...
            "columns"	: [
            	...
            	{width: '10%',	key: 'apprSiNum',				title: ['연번','연번'],		sort:true, move:true, resize: true, styleclassname: {data: 'aligncenter fontsize13'}},
            	{width: '7%',	key: 'reqDt',			title: ['신청일자','신청일자'],		sort:true, move:true, resize: true, styleclassname: {data: 'aligncenter fontsize13'}},
            	{width: '15%',	key: 'apltTitlNm',	title: ['신청자의 관직·성명','신청자의 관직·성명'],		sort:true, move:true, resize: true, styleclassname: {data: 'aligncenter fontsize13'}},
            	{width: '7%',	key: 'apprDocNum',				title: ['통신사실확인 자료제공요청','허가서 번호'],		sort:true, move:true, resize: true, styleclassname: {data: 'aligncenter fontsize13'}},
            	{width: '7%',	key: 'spNm',			title: ['통신사실확인 자료제공요청','통지 대상자'],		sort:true, move:true, resize: true, styleclassname: {data: 'aligncenter fontsize13'}},
            	{width: '7%',	key: 'rcptIncNum',			title: ['통신사실확인자료제공 요청집행사건','사건번호'], options:{limit:'number'},		sort:true, move:true, resize: true, styleclassname: {data: 'aligncenter fontsize13'}},
            	{width: '16%',	key: 'handDtRst',			title: ['통신사실확인자료제공 요청집행사건','처리일자 및 처리결과'], options:{limit:'number'},		sort:true, move:true, resize: true, styleclassname: {data: 'aligncenter fontsize13'}},
            	{width: '7%',	key: 'notcDt',				title: ['통신사실확인자료제공 요청집행사건','통보받은 일자'],		sort:true, move:true, resize: true, styleclassname: {data: 'aligncenter fontsize13'}},	                	
            	{width: '7%',	key: 'apprDt',			title: ['승인일자','승인일자'],		sort:true, move:true, resize: true, styleclassname: {data: 'aligncenter fontsize13'}},
            	{width: '10%',	key: 'clarAftrNotcDt',				title: ['유예사유 해소후 통지일자','유예사유 해소후 통지일자'],		sort:true, move:true, resize: true, styleclassname: {data: 'aligncenter fontsize13'}},
...
function handleUI(){
	...
	//수정일 경우, 수정 버튼 노출 
		...
		if($("#userId").val() == m0127VOMap.regUserId){
			areaSetWrite($("#contentsArea"));
