...
//출력 
function prnData(){
	goAjax("/sjpb/M/M0121selectList.face", m0121SCMap, callBackPrnDataSuccess);
}
...
function callBackPrnDataSuccess(data){
	...
	m0121RTMap.rexdataset = data.qCell;
...
function selectList(selectPkNum){
	...
	goAjax("/sjpb/M/M0121selectList.face", m0121SCMap, function (data){callBackSelectListSuccess(data, selectPkNum)});
}
...
function showList(data, selectPkNum){
	...
	var QCELLProp = {
            ...
            "columns"	: [
            	...
            	{width: '7%',	key: 'reqDt',				title: ['신청일자','신청일자'],		sort:true, move:true, resize: true, styleclassname: {data: 'aligncenter fontsize13'}},
            	...
            	{width: '7%',	key: 'notcRecvDt',				title: ['통신제한조치 집행사건','통보받은일자'],		sort:true, move:true, resize: true, styleclassname: {data: 'aligncenter fontsize13'}},
            	{width: '7%',	key: 'apprDt',				title: ['승인일자','승인일자'],		sort:true, move:true, resize: true, styleclassname: {data: 'aligncenter fontsize13'}},
            	{width: '9%',	key: 'clarAftrNotcDt',				title: ['유예사유 해소후 통지일자','유예사유 해소후 통지일자'],		sort:true, move:true, resize: true, styleclassname: {data: 'aligncenter fontsize13'}},
