...
//출력 
function prnData(){
	goAjax("/sjpb/M/M0125selectList.face", m0125SCMap, callBackPrnDataSuccess);
}
...
function callBackPrnDataSuccess(data){
	...
	m0125RTMap.rexdataset = data.qCell;
...
function selectList(selectPkNum){
	...
	goAjax("/sjpb/M/M0125selectList.face", m0125SCMap, function (data){callBackSelectListSuccess(data, selectPkNum)});
}
...
function showList(data, selectPkNum){
	...
	var QCELLProp = {
            ...
            "columns"	: [
            	...
            	{width: '10%',	key: 'reqDt',				title: ['요청일자'],		sort:true, move:true, resize: true, styleclassname: {data: 'aligncenter fontsize13'}},
            	...
            	{width: '40%',	key: 'dtaRnge',			title: ['제공받은 자료의 범위'], options:{limit:'number'},		sort:true, move:true, resize: true, styleclassname: {data: 'aligncenter fontsize13'}},
            	{width: '10%',	key: 'repyDt',			title: ['회신일자'], options:{limit:'number'},		sort:true, move:true, resize: true, styleclassname: {data: 'aligncenter fontsize13'}},
...
function handleUI(){
	...
	//수정일 경우, 수정 버튼 노출 
		...
		if($("#userId").val() == m0125VOMap.regUserId){
			areaSetWrite($("#contentsArea"));
