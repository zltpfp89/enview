...
function doSearch(){
	...
	goAjax("/sjpb/N/selectList.face", n0201SCMap, callBackSelectListSuccess);
}
...
function callBackSelectListSuccess(data, cmctDtaBkNum){
	...
	var QCELLProp = {
            ...
            "columns"	: [
            	...
            	{width: '20%',	key: 'moblPhonNum',			title: ['계좌번호'],		sort:true, move:true, resize: true, styleclassname: {data: 'aligncenter fontsize18'}},            	
