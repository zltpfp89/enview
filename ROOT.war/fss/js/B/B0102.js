...
function selectStsGrapList(){
	...
	$.each(b0101VOMap.incSpVOList, function(i, incSpVO) {
		...
		var incSpNmDec = Base64.decode(incSpVO.spNm);
...
//		}
		...
		$.each(incSpVO.actVioVOList, function(j, ActVioVO) {
			...
			if(ActVioVO.occrStsGrapVO != null){		//수정 
				btnHtml_1.append("<a href=\"javascript:updateOccrStsGrapView('"+ActVioVO.incSpNum+"','"+ActVioVO.actVioNum+"','"+ActVioVO.rcptNum+"','"+ActVioVO.rltActCriNmCd+"','"+ActVioVO.rltActCriNmCdDesc+"','"+rltActHtml+"','"+incSpNmDec+"',"+isSpStsGrapView+")\" class=\"btn_blue\" data-name=\"occrStsGrapBtn\" data-rltactcrinmcd=\""+ActVioVO.rltActCriNmCd+"\" data-occrstsgrapnum=\""+ActVioVO.occrStsGrapVO.occrStsGrapNum+"\" data-incspnum=\""+ActVioVO.incSpNum+"\" data-rcptnum=\""+incSpVO.rcptNum+"\" data-actvionum=\""+ActVioVO.actVioNum+"\" data-always=\"y\"><span>수정</span></a>");
			}else{	//신규작성
				btnHtml_1.append("<a href=\"javascript:updateOccrStsGrapView('"+ActVioVO.incSpNum+"','"+ActVioVO.actVioNum+"','"+ActVioVO.rcptNum+"','"+ActVioVO.rltActCriNmCd+"','"+ActVioVO.rltActCriNmCdDesc+"','"+rltActHtml+"','"+incSpNmDec+"',"+isSpStsGrapView+")\" class=\"btn_white\" data-name=\"occrStsGrapBtn\" data-rltactcrinmcd=\""+ActVioVO.rltActCriNmCd+"\" data-occrstsgrapnum=\"\" data-incspnum=\""+ActVioVO.incSpNum+"\" data-rcptnum=\""+incSpVO.rcptNum+"\" data-actvionum=\""+ActVioVO.actVioNum+"\"><span>작성</span></a>");
			}
			
			
			//작성한 검거통계원표 데이터가 있으면, 
			if(ActVioVO.arstStsGrapVO != null){		//수정 
				btnHtml_2.append("<a href=\"javascript:updateArstStsGrapView('"+ActVioVO.incSpNum+"','"+ActVioVO.actVioNum+"','"+ActVioVO.rcptNum+"','"+ActVioVO.rltActCriNmCd+"','"+ActVioVO.rltActCriNmCdDesc+"','"+rltActHtml+"','"+incSpNmDec+"',"+isSpStsGrapView+")\" class=\"btn_blue\" data-name=\"arstStsGrapBtn\" data-rltactcrinmcd=\""+ActVioVO.rltActCriNmCd+"\" data-arststsgrapnum=\""+ActVioVO.arstStsGrapVO.arstStsGrapNum+"\" data-incspnum=\""+ActVioVO.incSpNum+"\" data-rcptnum=\""+incSpVO.rcptNum+"\" data-actvionum=\""+ActVioVO.actVioNum+"\" data-always=\"y\"><span>수정</span></a>");
			}else{
				btnHtml_2.append("<a href=\"javascript:updateArstStsGrapView('"+ActVioVO.incSpNum+"','"+ActVioVO.actVioNum+"','"+ActVioVO.rcptNum+"','"+ActVioVO.rltActCriNmCd+"','"+ActVioVO.rltActCriNmCdDesc+"','"+rltActHtml+"','"+incSpNmDec+"',"+isSpStsGrapView+")\" class=\"btn_white\" data-name=\"arstStsGrapBtn\" data-rltactcrinmcd=\""+ActVioVO.rltActCriNmCd+"\" data-arststsgrapnum=\"\" data-incspnum=\""+ActVioVO.incSpNum+"\" data-rcptnum=\""+incSpVO.rcptNum+"\" data-actvionum=\""+ActVioVO.actVioNum+"\"><span>작성</span></a>");
			}
...
//'발생' 통계원표 등록, 수정 화면 노출
function updateOccrStsGrapView(incSpNum, actVioNum, rcptNum, rltActCriNmCd, rltActCriNmCdDesc, actVioClaNm, incSpNmDec, isSpStsGrapView){
//function updateOccrStsGrapView(incSpNum, actVioNum){
	...
	goAjaxDefault("/sjpb/B/selectOccrStsGrap.face", reqMap,  function(data){callBackUpdateOccrStsGrapViewSuccess(data, incSpNum, actVioNum, rcptNum, rltActCriNmCd, rltActCriNmCdDesc, actVioClaNm, incSpNmDec, isSpStsGrapView)});
	
}

//'발생' 통계원표 등록, 수정 화면 노출 성공함수
function callBackUpdateOccrStsGrapViewSuccess(data, incSpNum, actVioNum, rcptNum, rltActCriNmCd, rltActCriNmCdDesc, actVioClaNm, incSpNmDec, isSpStsGrapView){
	...
	//'피의자' 통계원표 탭 노출 여부 
	setSpStsGrapTabView(isSpStsGrapView);
	...
	if(occrStsGrapVOMap == null){	//신규 
		...
		//신규등록화면 노출
		insertOccrStsGrapView(incSpNum, rcptNum, actVioNum, rltActCriNmCd, rltActCriNmCdDesc, actVioClaNm, incSpNmDec, isSpStsGrapView);
		...
		//sub 탭 링크 셋팅 
		setStsGrapSubTabLink(incSpNum, rcptNum, actVioNum, rltActCriNmCd, rltActCriNmCdDesc, actVioClaNm, incSpNmDec, isSpStsGrapView);
...
function setSpStsGrapArea(spStsGrapVO){
	...
	//피의자정보
	setFieldValue($("#sp_spNm"), Base64.decode(incSpVOGrapMap.spNm));				//피의자이름
	setFieldValue($("#sp_spIdNum"), Base64.decode(incSpVOGrapMap.spIdNum));		//피의자식별번호
...
//'발생' 통계원표 작성 화면노출
function insertOccrStsGrapView(incSpNum, rcptNum, actVioNum, rltActCriNmCd, rltActCriNmCdDesc, actVioClaNm, incSpNmDec, isSpStsGrapView){
	//incSpNum	: 사건피의자번호
	//rcptNum 	: 접수번호
	//actVioNum	: 법률위반번호
...
//sub 탭 링크 셋팅 
function setStsGrapSubTabLink(incSpNum, rcptNum, actVioNum, rltActCriNmCd, rltActCriNmCdDesc, actVioClaNm, incSpNmDec, isSpStsGrapView){
	$("#occrStsGrapLink").attr("href", "javascript:updateOccrStsGrapView('"+incSpNum+"','"+actVioNum+"','"+rcptNum+"','"+rltActCriNmCd+"','"+rltActCriNmCdDesc+"','"+actVioClaNm+"','"+incSpNmDec+"',"+isSpStsGrapView+")");
	$("#arstStsGrapLink").attr("href", "javascript:updateArstStsGrapView('"+incSpNum+"','"+actVioNum+"','"+rcptNum+"','"+rltActCriNmCd+"','"+rltActCriNmCdDesc+"','"+actVioClaNm+"','"+incSpNmDec+"',"+isSpStsGrapView+")");
	$("#spStsGrapLink").attr("href", "javascript:updateSpStsGrapView('"+incSpNum+"','"+actVioNum+"','"+rcptNum+"','"+rltActCriNmCd+"','"+rltActCriNmCdDesc+"','"+actVioClaNm+"','"+incSpNmDec+"',"+isSpStsGrapView+")");
}
...
//'검거' 통계원표 등록, 수정 화면 노출
function updateArstStsGrapView(incSpNum, actVioNum, rcptNum, rltActCriNmCd, rltActCriNmCdDesc, actVioClaNm, incSpNmDec, isSpStsGrapView){
//function updateArstStsGrapView(incSpNum, actVioNum){
	...
	goAjaxDefault("/sjpb/B/selectArstStsGrap.face", reqMap, function(data){ callBackUpdateArstStsGrapViewSuccess(data, incSpNum, actVioNum, rcptNum, rltActCriNmCd, rltActCriNmCdDesc, actVioClaNm, incSpNmDec, isSpStsGrapView)});
}

//'검거' 통계원표 등록, 수정 화면 노출 성공 콜백함수
function callBackUpdateArstStsGrapViewSuccess(data, incSpNum, actVioNum, rcptNum, rltActCriNmCd, rltActCriNmCdDesc, actVioClaNm, incSpNmDec, isSpStsGrapView){
	...
	if(arstStsGrapVOMap == null){	//신규
		insertArstStsGrapView(incSpNum, rcptNum, actVioNum, rltActCriNmCd, rltActCriNmCdDesc, actVioClaNm, incSpNmDec, isSpStsGrapView);
...
//'검거' 통계원표 작성 화면노출
function insertArstStsGrapView(incSpNum, rcptNum, actVioNum, rltActCriNmCd, rltActCriNmCdDesc, actVioClaNm, incSpNmDec, isSpStsGrapView){
	//incSpNum	: 사건피의자번호
	//rcptNum 	: 접수번호
	//actVioNum	: 법률위반번호
	//rltActCriNmCdDesc	: 죄명
...
//'피의자' 통계원표 노출
function setSpStsGrapTabView(isSpStsGrapView){
	//피의자 통계원표 탭 노출
	if(isSpStsGrapView){
...
function updateSpStsGrapView(incSpNum, actVioNum, rcptNum, rltActCriNmCd, rltActCriNmCdDesc, actVioClaNm, incSpNmDec, isSpStsGrapView){
	...
	goAjaxDefault("/sjpb/B/selectSpStsGrap.face", reqMap, function(data){callBackUpdateSpStsGrapViewSuccess(data, incSpNum, actVioNum, rcptNum, rltActCriNmCd, rltActCriNmCdDesc, actVioClaNm, incSpNmDec, isSpStsGrapView)});
}

//'피의자' 통계원표 등록, 수정 화면 노출 성공 콜백함수
function callBackUpdateSpStsGrapViewSuccess(data, incSpNum, actVioNum, rcptNum, rltActCriNmCd, rltActCriNmCdDesc, actVioClaNm, incSpNmDec, isSpStsGrapView){
	...
	if(spStsGrapVOMap == null){	//신규
		insertSpStsGrapView(incSpNum, actVioNum, rcptNum, rltActCriNmCd, rltActCriNmCdDesc, actVioClaNm, incSpNmDec, isSpStsGrapView);
	}else{	//수정
...
//'피의자' 통계원표 작성 화면노출
function insertSpStsGrapView(incSpNum, actVioNum, rcptNum, rltActCriNmCd, rltActCriNmCdDesc, actVioClaNm, incSpNmDec, isSpStsGrapView){
	//incSpNum	: 사건피의자번호
	//rcptNum 	: 접수번호
	//actVioNum	: 법률위반번호
	//rltActCriNmCdDesc	: 죄명
...
//TODO 삭제 필요 - 발생통계원표 테스트 데이터 셋팅 
function setOccrStsGrapTestData(){
	
	//가정폭력유무
	$("input[name=occr_famyVioYnCd]:radio[value='1']").prop("checked", true);
	//학교폭력유무
	$("input[name=occr_schlVioYnCd]:radio[value='1']").prop("checked", true);
	//외국인피의자관련
	$("input[name=occr_forgSpYnCd]:radio[value='1']").prop("checked", true);
	
	//발생년월일시
	$("input[name=occr_occrYrmhDtDivCd]:radio[value='1']").prop("checked", true);
	//발생년월일시, 년 월 일 시 
	setSelectBoxIndex($("select[name=occr_occrYrmhDt_year]"), 1);
	setSelectBoxIndex($("select[name=occr_occrYrmhDt_month]"), 1);
	setSelectBoxIndex($("select[name=occr_occrYrmhDt_day]"), 1);
	setSelectBoxIndex($("select[name=occr_occrYrmhDt_time]"), 1);
	
	//인지년월암일시, 년 월 일 시 
	setSelectBoxIndex($("select[name=occr_recgYrmhDt_year]"), 1);
	setSelectBoxIndex($("select[name=occr_recgYrmhDt_month]"), 1);
	setSelectBoxIndex($("select[name=occr_recgYrmhDt_day]"), 1);
	setSelectBoxIndex($("select[name=occr_recgYrmhDt_time]"), 1);
	
	$("input[name=occr_occrYrmhDtDotw]").val("월");				//발생요일
	$("input[name=occr_recgYrmhDtDotw]").val("화");				//인지요일
	
	//발생부터인지까지기간
	setSelectBoxIndex($("select[name=occr_occrToRecgPi]"), 3);
	//범죄수법
	setSelectBoxIndex($("select[name=occr_criMeth]"), 1);
	//발생일특수사정
	setSelectBoxIndex($("select[name=occr_occrDtSpelSitu]"), 1);
	//범행시일기
	setSelectBoxIndex($("select[name=occr_criTimeWeth]"), 1);
	//수사단서
	setSelectBoxIndex($("select[name=occr_criClue]"), 1);
	//미신고이유
	setSelectBoxIndex($("select[name=occr_undcRsn]"), 1);
	
	//피해자 성별
	$("input[name=occr_vicm]:radio[value='1']").prop("checked", true);
	//피해자 연령
	$("input[name=occr_ageDivCd]:radio[value='1']").prop("checked", true);
	$("input[name=occr_age]").val("29");
	
	//피해자 피해시 상황
	setSelectBoxIndex($("select[name=occr_vicmDamgTimeSitu]"), 1);
	//발생지 구분
	setSelectBoxIndex($("select[name=occr_occrAreaDiv]"), 1);
	$("select[name=occr_occrAreaDiv]").trigger("change");
	//발생지
	setSelectBoxIndex($("select[name=occr_occrArea]"), 1);
	
	//발생장소
	setSelectBoxIndex($("select[name=occr_occrPla]"), 1);
	
	//피해정도
	setSelectBoxIndex($("select[name=occr_propDamgDegr]"), 1);
	
	//피해액
	//1. 화폐
	$("input[name=occr_damgAmtMony]").val("1000");
	//2. 자동차
	$("input[name=occr_damgAmtCar]").val("1000");
	//3. 유가증권
	$("input[name=occr_damgAmtMarkSecu]").val("1000");
	//4. 귀금속
	$("input[name=occr_damgAmtJewy]").val("1000");
	//5. 전기 전자제품
	$("input[name=occr_damgAmtElecElenProd]").val("1000");
	//6. 오토바이자전거
	$("input[name=occr_damgAmtMocyBike]").val("1000");
	//7. 가구류
	$("input[name=occr_damgAmtFurnArtc]").val("1000");
	//8. 의류
	$("input[name=occr_damgAmtClot]").val("1000");
	//9. 기계류
	$("input[name=occr_damgAmtMach]").val("1000");
	//10. 농임산물
	$("input[name=occr_damgAmtFarmFortProd]").val("1000");
	//11. 축산물
	$("input[name=occr_damgAmtAmhbProd]").val("1000");
	//12. 수산물
	$("input[name=occr_damgAmtMarnProd]").val("1000");
	//13. 잡화
	$("input[name=occr_damgAmtMcgd]").val("1000");
	//14. 기타
	$("input[name=occr_damgAmtEtc]").val("1000");
	//피해액 합계
	$("#occr_damgAmtTot").html("14000");
	
	
	//피해구분
	$("input[name=occr_bodyDamgZero]:eq(0)").prop("checked", true);
	//상해정도
	setSelectBoxIndex($("select[name=occr_bodyDamgInjyDegr]"), 1);
	
}

//TODO 삭제 필요 - 검거통계원표 테스트 데이터 셋팅 
function setArstStsGrapTestData(){
	var thisName = "";
	$("#tab_small_m1_contents .m2").find("input, select, span").each(function(){
...
//TODO 삭제 필요 - 피의자통계원표 테스트 데이터 셋팅 
function setSpStsGrapTestData(){
	var thisName = "";
	$("#tab_small_m1_contents .m3").find("input, select, span").each(function(){
