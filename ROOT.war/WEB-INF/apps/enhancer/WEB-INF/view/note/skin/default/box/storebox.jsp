...
<form id="receivebox" name="receivebox" method="post" onsubmit="return false;">
	...
	<div class="searchForm">
		<div class="work"><util:message key="hn.note.label.storeBox"/></div>
		<div class="searchButton" onclick="javascript:enNote.searchStoreNotes(event);"><util:message key="hn.note.label.search"/></div>
		<input type="text" name="searchValue" id="searchValue" class="inputField searchValue" onkeyup="javascript:enNote.searchStoreNotes(event);">
	...
	<div class="controlPanel">
		<div title="delete" class="noteButton deleteButton" onclick="javascript:enNote.deleteStoreNotes();"><util:message key="hn.note.label.delete"/></div>
		<div title="nextPage" class="noteButton2 next" onclick="javascript:enNote.viewStoreBox(<c:out value="${notePage.nextPage}"/>)"><util:message key="hn.note.label.next"/></div>
		<div title="prevPage" class="noteButton2 prev" onclick="javascript:enNote.viewStoreBox(<c:out value="${notePage.prevPage}"/>)"><util:message key="hn.note.label.prev"/></div>
		<div title="reload" class="noteButton reload" onclick="javascript:enNote.viewStoreBox(-1);"><util:message key="hn.note.label.reload"/></div>
	</div>
...
<c:if test="${empty form.noteFormList}">
	<div class="noNoteList"><util:message key="hn.note.label.hasNotStoreNote"/></div>
</c:if>
