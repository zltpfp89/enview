...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=request.getContextPath()%>/hancer/javascript/note/enview/search.js"></script>
		
		<link rel="stylesheet" href="<%=request.getContextPath()%>/hancer/css/note/enview/search.css" type="text/css">
	</head>
	<body>
