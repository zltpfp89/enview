...
<div id="scheduleDetails" class="scheduleEdit scheduleDetails<!--c:if test="${calendar.bilingual && calendar.public }"-->Public<!--/c:if-->">
	...
	<div id="scheduleDetailHeader" class="scheduleDetail<!--c:if test="${calendar.bilingual && calendar.public }"-->Public<!--/c:if--> header">
	...
	<div id="scheduleDetailContent1" class="scheduleDetail content">
		...
		<div class="scheduleAlarm">
			<input type="radio" name="alarmPattern" id="alarmPattern_b10m"  value="b10m" disabled="disabled" checked="checked" /><label class="valLabel" for="alarmPattern_b10m"><util:message key='hn.title.schedule.alarmPattern.b10m'/></label>
			<input type="radio" name="alarmPattern" id="alarmPattern_b20m"  value="b20m" disabled="disabled" <c:if test="${schedule.alarmPattern == 'b20m' }">checked="checked"</c:if>/><label class="valLabel" for="alarmPattern_b20m"><util:message key='hn.title.schedule.alarmPattern.b20m'/></label>
			<input type="radio" name="alarmPattern" id="alarmPattern_b1h"   value="b1h"  disabled="disabled" <c:if test="${schedule.alarmPattern == 'b1h'  }">checked="checked"</c:if>/><label class="valLabel" for="alarmPattern_b1h"><util:message key='hn.title.schedule.alarmPattern.b1h'/></label>
			<input type="radio" name="alarmPattern" id="alarmPattern_b12h"  value="b12h" disabled="disabled" <c:if test="${schedule.alarmPattern == 'b12h' }">checked="checked"</c:if>/><label class="valLabel" for="alarmPattern_b12h"><util:message key='hn.title.schedule.alarmPattern.b12h'/></label>
			<input type="radio" name="alarmPattern" id="alarmPattern_b1d"   value="b1d"  disabled="disabled" <c:if test="${schedule.alarmPattern == 'b1d'  }">checked="checked"</c:if>/><label class="valLabel" for="alarmPattern_b1d"><util:message key='hn.title.schedule.alarmPattern.b1d'/></label>
		</div>
	...
	<!--/c:if-->
	<div id="scheduleDetailFooter" class="scheduleDetail<!--c:if test="${calendar.bilingual && calendar.public }"-->Public<!--/c:if--> footer">
