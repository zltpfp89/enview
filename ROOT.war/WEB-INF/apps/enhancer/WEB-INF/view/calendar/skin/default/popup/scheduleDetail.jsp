...
<div id="scheduleDetails" class="scheduleEdit scheduleDetailsPublic">
	...
	<div id="scheduleDetailHeader" class="scheduleDetailPublic header">
	...
	<div id="scheduleDetailContent1" class="scheduleDetail content">
		<div id="scheduleCalendar" class="scheduleCalendar">
			...
			<!--c:forEach items="${scheduleLangList }" var="lang" varStatus="status"-->
				<div class="scheduleName" id="scheduleName"><label class="scheduleNameLabel" for="name">제목</label><input class="scheduleNameInput" maxlength="100" id="name" type="text" langKnd="<c:out value="${lang.langKnd }"/>" name="name" value="<c:out value="${lang.name }" escapeXml="false"/>"/></div>
			<!--/c:forEach-->
	...
	<div id="scheduleDetailContent3" class="scheduleDetail content">
		...
		<div class="schedulePlaces">
			<label class="schedulePlaceLabel"><util:message key='hn.title.schedule.place'/></label><input type="text" id="place" name="place" value=""/>
		</div>
		<div class="scheduleComments">
			<label class="scheduleCommentsLabel"><util:message key='hn.title.schedule.comments'/></label><textarea id="comments" name="comments" cols="58" rows="3"></textarea>
		</div>
		<!--/c:forEach-->
		
	</div>
	
	<div id="scheduleDetailFooter" class="scheduleDetailPublic footer">
