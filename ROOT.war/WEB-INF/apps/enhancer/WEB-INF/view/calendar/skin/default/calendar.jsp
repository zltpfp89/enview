					...
					<div class="myCalendarList calendarList" id="myCalendarList">
						<c:forEach items="${calList}" var="cal">
							<div class="calendarInfo" id="<c:out value="${cal.calendarId}"/>_CalToggle" title="<c:out value="${cal.name}"/>">
								...
								<label class="calendarName"><c:out value="${cal.name}"/></label><span class="calendarPopupButton triangleButton myCalendarRButton ui-icon ui-icon-triangle-1-s" calendarId="<c:out value="${cal.calendarId}"/>"></span>
