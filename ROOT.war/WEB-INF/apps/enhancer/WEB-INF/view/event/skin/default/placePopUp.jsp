			...
			<div class="detail">
				...
				<div class="board first">
					...
					<div class="tsearchArea">
						<h1><%=msgs.getString("ev.hnevent.label.selectPlace")%></h1>
					</div>
					<!-- searchArea//-->
					<form name="srchPlace" id="srchPlace" action="" method="post">
						<table id="grid-table" cellpadding="0" cellspacing="0" summary="게시판" class="table_board">
							...
							<tr>
								<th class="L" scope="row"><input type="radio" name="place" value="self" onclick="setRadio();"/><%=msgs.getString("ev.hnevent.label.directInput")%></th>
								<td class="L">
									<input type="text" title="place name" name="pNmSelf" id="pNmSelf" class="txt_200" />&nbsp;&nbsp;<a class="btn_B" onclick="addEvPlaceSelf();"><span><%=msgs.getString("ev.hnevent.label.input")%></span></a>
								</td>
							</tr>
							<tr>
								<th class="L" scope="row"><input type="radio" name="place" value="srch" onclick="setRadio();"/><%=msgs.getString("ev.hnevent.label.searchInUniv")%></th>
								<td class="L">
									<div class="sel_100">
										<select name="list" id="list" class="txt_100" title="place list">
									...
									<input type="text" title="place name" name="pName" id="pName" class="txt_200" onkeydown="javascript:fn_EnterKey(this);" onpaste="javascript:return false;" />&nbsp;
									<a class="btn_search" onclick="srchEvPlace();"><span><%=msgs.getString("ev.hnevent.label.search")%></span></a>
								</td>
							</tr>
							<tr>
								<td colspan="2">
									<div id="place_list"><font color="red">[<%=msgs.getString("ev.hnevent.msg.event.limitMapInfo")%>]</font></div>
								</td>
							</tr>
						</table>
					</form>
