		...
		<div id="cafeTItle" class="CF0102_bgHeight titleArea">
			...
			<div id="title_cafeMenus" class="CF0105_display CF0105_position CF0105_bgColor CF0105_brdrStyle CF0105_brdrWidth CF0105_brdrColor title_cafeTitleMenus">
				<c:forEach items="${ menuList }" var="menu" varStatus="status">
					<div class="CF0105_fontNm CF0105_baseFontColor title_cafeTitleMenu" id="titmeMenu_<c:out value="${menu.menuId}"/>" onclick="javascript:cfTitle.selectMenu('<c:out value="${menu.menuId}"/>','<c:out value="${ menu.boardId }"/>');"><c:out value="${menu.menuNm}"/></div>
