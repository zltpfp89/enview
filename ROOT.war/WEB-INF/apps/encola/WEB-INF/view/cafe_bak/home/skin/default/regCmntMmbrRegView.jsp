...
<div class="cafeformpanel" style="width:100%;">
  <dl>
  <dt><h2>카페에서 사용할 닉네임</h2></dt>
  <dd>
    <table cellpadding=0 cellspacing=0 border=0 width='100%'>
	  <tr><td colspan="2" width="100%" class="cafeformheaderline"></td></tr>
      <tr>
	    <td width="20%" class="cafeformlabel"><img src="<%=request.getContextPath()%>/cola/cafe/images/tb_icon.gif" width="5" height="5" align="absmiddle">닉네임</td>
	    <td class="cafeformfield" align="left">
		  <input id="userNick" name="userNick" maxlength="30"/>
