...
<c:if test="${suForm.view == 'list'}">
	...
	<div class="adgridpanel" style="float: right; border: none;">
	    ...
	    <span class="btn_pack medium"><a href="javascript:superMngr.getTplMngr().doDelete()">삭제</a></span>
	</div>
...
<c:if test="${suForm.view == 'pref'}">
	...
	<div class="adgridpanel" style="float: right; border: none;">
	    ...
	    <span class="btn_pack medium"><a href="javascript:superMngr.getTplMngr().doSave('<c:out value="${suForm.view}"/>')">저장</a></span>
	</div>
</c:if>	
<%--END::템플릿 세부화면--%>
<%--BEGIN::템플릿 신규화면--%>
<c:if test="${suForm.view == 'new'}">
	...
	<%-- END::부가 영역 템플릿 --%>
	<div class="adgridpanel" style="float: right; border: none;">
	    <span class="btn_pack medium"><a href="javascript:superMngr.getTplMngr().doCreate()">저장</a></span>
	</div>
</c:if>
<%--END::템플릿 신규화면--%>	