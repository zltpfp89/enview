...
<div class="cntt_extraInfo_wrap CF0501_nmBrdrColor">
	...
	<div class="cntt_extraInfo_title CF0501_nmBrdrColor">
		<span class="CF0501_nmFontColor"><util:message key="cf.title.edit.myInfo"/></span>
	</div>
		...
		<div class="myinfo_wrap">
			<fieldset class="myinfo_field">
				...
				<dl class="reg_form">
					...
					<dd>
						<input name="userNick" class="inp" id="userNick" type="text" maxLength="10" value="<c:out value="${mmbrVO.userNick}"/>" size="36"
				...
				<dl class="reg_form">
					<dt>ㆍ <util:message key="cf.title.shareID"/></dt>
					<dd>
				...
				<dl class="reg_form">
					<dt>ㆍ <util:message key="cf.title.shareName"/></dt>
					<dd>
				...
				<dl class="reg_form">
					<dt>ㆍ <util:message key="cf.title.shareGender"/></dt>
					<dd>
			...
			<fieldset class="myinfo_field lineT CF0501_nmBrdrColor"><legend><util:message key="cf.prop.otherInformation"/></legend>
				<!-- 
				<dl class="reg_form">
					<dt>ㆍ 수신설정</dt>
					<dd>
							...
							<div class="preiview_area">
								<div id="img_blog" style="display: none;">
									<p class="blank_thumb">
										...
										<a class="del_thum" id="delThumBlog" style="display: none;" onclick="delImg(); return false;" href="javascript:;">삭제</a>
								...
								<div id="img_direct" style="display: block;">                            
									<p class="blank_thumb" id="preview_img_wrap">
										...
										<a class="del_thum" id="delThumDirect" style="display: block;" onclick="delImg(); return false;" href="javascript:;">삭제</a>
				...
				-->
				<dl class="reg_form">
					<dt>ㆍ <util:message key="cf.title.joinDate"/></dt>
					<dd><c:out value="${mmbrVO.regDatimPF}"/></dd>
				</dl>
				<dl class="reg_form">
					<dt>ㆍ <util:message key="cf.title.visits"/></dt>
					<dd><c:out value="${mmbrVO.visitCntCF}"/> <util:message key="cf.prop.times"/></dd>
				</dl>
			</fieldset>
			<div class="cl">&nbsp;</div>
		</div>  <!-- end myinfo_wrap -->
	...
	<div class="btn_center">
		<input type="button" class="CF0601_srchBtn btn40" value='<util:message key="ev.title.update"/>'  onclick="cfCntt.m_updMyInfo.update()"/>
		<input type="button" class="CF0601_srchBtn btn40" value='<util:message key="ev.title.cancel"/>'  onclick="cfCntt.m_updMyInfo.cancel()"/>
		<%--
		<a onclick="cfCntt.m_updMyInfo.update()"><img alt="수정" src="/cola/cafe/images/each/encafe/cntt/btn_modify.gif"></a>
		<a onclick="cfCntt.m_updMyInfo.cancel()"><img alt="취소" src="/cola/cafe/images/each/encafe/cntt/btn_cancel.gif"></a>
		 --%>
	</div>
</div>