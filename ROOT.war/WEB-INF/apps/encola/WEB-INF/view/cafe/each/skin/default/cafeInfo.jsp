	...
	<dl class="CF0301_baseBrdrColor">
		...
		<dd>
			<span class="cafeinfo_left_tit">
				<label class="CF0301_baseFontColor"><util:message key="cf.title.sysop"/></label>
			</span>
			<span>
		...
		<dd>
			<span class="cafeinfo_left_tit">
				<a class="link CF0301_baseFontColor"  href="#"><util:message key="cf.title.mmbrCnt"/></a>
			</span>
			<span>
		...
		<dd>
			<span class="cafeinfo_left_tit">
				<a class="link CF0301_baseFontColor" href="#"><util:message key="cf.title.visitCount"/></a>
			</span>
			<span>
			...
			<a class="right_btn link opacity CF0301_baseFontColor" onclick="cfInfo.showProfile()"><util:message key="cf.title.profile"/></a>
		</dd>
	</dl>
	<dl class="CF0301_baseBrdrColor">
		<dd>
		...
		<c:if test="${!mmbrVO.isMmbr}">
		<dd class="btn_write">
			<p class="btn_pd"><a class="btn_big CF0301_baseFontColor" onclick="cfInfo.regCmntMmbr()"><strong>카페 가입하기</strong></a></p>
		</dd>
		</c:if>
	</dl>
