	  ...
	  <table id="grid-table" width="100%" border="0" cellspacing="0" cellpadding="0">
		<thead>
		  ...
		  <tr style="cursor: pointer;">
			...
			<th class="cafegridheader"><span><util:message key="cf.title.joinDate"/></span></th>
			<th class="cafegridheaderlast"><span><util:message key="cf.title.last.visited"/></span></th>	
		  </tr>
		</thead>
