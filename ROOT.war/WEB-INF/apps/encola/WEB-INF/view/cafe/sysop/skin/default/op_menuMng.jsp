      ...
      <td class="cafegridpanel" width="75%" valign="top">
		...
		<div id="menu_form<c:out value="${menu.menuId}"/>" class="cafeformpanel" style="display:none">
		  ...
		  <c:if test="${menu.menuType == 'S'}">
		  	<tr id="trCommentS" ><td colspan="100" width="100%" height="30" class="cafeformlabellast" align="center">분리자가 설정되었습니다.</td></tr>
		  </c:if>
		  <c:if test="${menu.menuType == 'E'}">
		  	<tr id="trCommentE" ><td colspan="100" width="100%" height="30" class="cafeformlabellast" align="center">여백이 설정되었습니다.</td></tr>
		  </c:if>
