...
<form id="all_srchForm" name="all_srchForm" method="POST" onsubmit="return false;">
	...
	<div style="width:680px; height:24px;">
		<div class="board_select_box fl"><span class="oran_title"><util:message key="cf.prop.wholeMembers"/></span></div>
		<!-- 검색 -->
		<div class="board_but_box480 fr">
			<select id="srchType" name="srchType" class="common_text">
					<option value="srchGrp"><util:message key="cf.title.groupName"/></option>
			</select>
			&nbsp;
	...
	<div class="table_box">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr class="table_33_line">
				...
				<td width="92%" class="gray_b_text"><util:message key="cf.prop.dept.name"/></td>
			</tr>
			<c:if test="${empty srchGroupList}" var="isGrpEmpty">
			<tr class="list_line">
					<td colspan="15" height="30" align="center">
						<util:message key="cf.error.not.exist.department"/>
					</td>
				</tr>
			</c:if>
