...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
  <table cellpadding=0 cellspacing=0 border=0 width=100% class=cafeformpanel>
	...
	<tr>
	  ...
	  <td class=cafeformfieldlast align=left id="smarteditor">
		<textarea id=close_content name=close_content style=width:100%;height:120px;display:none;>
	...
	<tr>
	  <td colspan=2 align=center>
	  	<span class="btn_pack small">
	  		<a href="#" onclick="javascript:cfOp.baseInfo.closeCafe('cancel')">폐쇄취소</a>
	  	</span>
	  </td>
	</tr>
	</c:if>
	...
	<tr>
	  <td colspan=2 align=center>
	  	<span class="btn_pack small">
	  		<a href="#" onclick="javascript:cfOp.baseInfo.closeCafe('defered')">폐쇄신청</a>
	  	</span>
	  </td>
	</tr>
	</c:if>
	...
	<tr>
	  <td colspan=2 align=center>
	  	<span class="btn_pack small">
			<a href="#" onclick="javascript:cfOp.baseInfo.closeCafe('realtime')">폐쇄신청</a>
		</span>
	</tr>
	</c:if>
	<%--END::회원이 없는 상태이면--%>
