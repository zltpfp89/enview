	...
	<div id="ConfigurationManager_ConfigurationTabPage" class="board first">
		...
		<div class="btnArea">
			<div class="rightArea">
				...
				<a href="javascript:superMngr.getTplMngr().doDelete()" class="btn_W"><span>삭제</span></a>
			</div>
		</div>
		<!-- btnArea//-->
	</div>
		...
		<table id="grid-table" cellpadding="0" cellspacing="0" summary="게시판" class="table_board">
			...
			<div class="btnArea">
				<div class="rightArea">
			    	...
			    	<a href="javascript:superMngr.getTplMngr().doSave('<c:out value="${suForm.view}"/>')" class="btn_W"><span>저장</span></a>					
				</div>
			</div>
			<!-- btnArea//-->																										
		</table>
...
<c:if test="${suForm.view == 'new'}">
	...
	<div class="board">
		<table id="grid-table" cellpadding="0" cellspacing="0" summary="게시판" class="table_board">
			...
			<div class="btnArea">
				<div class="rightArea">
			    	<a href="javascript:superMngr.getTplMngr().doCreate()" class="btn_W"><span>저장</span></a>					
				</div>
			</div>
			<!-- btnArea//-->																													
		</table>
