...
<script src="${cPath}/snu_cafe/js/jquery.min.js" type="text/javascript" ></script>
<script src="${cPath}/snu_cafe/js/slide.js" type="text/javascript" ></script>
<script src="${cPath}/snu_cafe/js/js.js" type="text/javascript" ></script>
