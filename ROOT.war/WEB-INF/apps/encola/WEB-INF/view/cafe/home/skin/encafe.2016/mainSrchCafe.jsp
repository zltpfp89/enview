...
<div>
  <font style="margin-right:20px;cursor:pointer" OnMouseOver="this.style.textDecoration='underline'" OnMouseOut="this.style.textDecoration='none'" onclick="cfHome.changeSrchType('nm')">카페이름</font>
  <font style="margin-right:20px;cursor:pointer" OnMouseOver="this.style.textDecoration='underline'" OnMouseOut="this.style.textDecoration='none'" onclick="cfHome.changeSrchType('tag')">카페태그</font>
...
<div>
  ...
  <font style="padding-right:20px;cursor:pointer" OnMouseOver="this.style.textDecoration='underline'" OnMouseOut="this.style.textDecoration='none'" onclick="cfHome.changeSrchSort('mmbr')">회원수</font>
  ...
  <ul style="list-style-type:none;padding:10px 5px 10px 5px">
	...
	<c:forEach items="${rsltList}" var="rslt">
	  <li style="padding-top:3px">
		...
		<span style="padding-right:20px"><c:out value="${rslt.cmntIntro}"/></span>
	  </li>
	</c:forEach>
  </ul>
