...
<div class="cafeformpanel" style="width: 100%; padding-right: 0px; padding-left: 0px;">
  <table cellpadding=0 cellspacing=0 border=0 width='100%'>
	...
	<tr>
	  <td width="20%" class="cafeformlabel">카테 고리</td>
	  <td class="cafeformfield" align="left">
	...
	<tr>
	  <td width="20%" class="cafeformlabel">카페 태그 *</td>
	  <td class="cafeformfield" align="left">
  ...
  <input type="hidden" id="makeCafe_themeNm" name="makeCafe_themeNm" maxLength="" class="full_cafetextfield" value="encafe"/>
