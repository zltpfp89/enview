...
<div class="board first">
	<table id="grid-table" cellpadding="0" cellspacing="0" summary="게시판" class="table_board">
		<tr>
			<td align="center">
				<font style="color:red"><b>모든 게시물을 대상으로 함으로 다소 시간이 걸릴 수 있습니다.</b></font>
				<span id="fixButton"><a href="javascript:fixAttachedFile()" class="btn_O"><span>게시물 첨부 파일 정리</span></a></span>
			</td>	
		</tr>
	</table>
</div>
