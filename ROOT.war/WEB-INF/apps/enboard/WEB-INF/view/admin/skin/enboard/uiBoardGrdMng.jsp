...
<div class="sub_contents">
	<div class="detail">
	  			...
	  			<table id="grid-table" cellpadding="0" cellspacing="0" summary="게시판" class="table_board">
	  				<thead>
						<tr>
							...
							<th><span class="table_title">등급</span></th>
							<th><span class="table_title">등급명</span></th>
							<th><span class="table_title">순서</span></th>
						</tr>
					</thead>
					<tbody>
							...
							<tr>
								...
								<c:if test="${!status.first}">
									<a href="javascript:admGradeMngr.doGrdDown('<c:out value="${status.index}"/>')" class="btn_W">
										<span class="btn_pack small">낮은 등급으로</span>
									</a>
								</c:if>
								</td>
							</tr>
		...
		<div id="authAccordion" class="board">
			<h3><a href="#">등급별 역할 배속</a></h3>
			<div>
				<span><img src='<%=evcp%>/board/images/admin/ic_triangle.gif' style='margin:0px 5px 0px 0px;' align=absmiddle> 역할을 배속시킬 등급을 선택하십시오.</span>
				<table id="grid-table" cellpadding="0" cellspacing="0" summary="게시판" class="table_board">
					<colgroup>
						<col width="140px" />
						<col width="*" />
			...
			<h3><a href="#">등급별 그룹 배속</a></h3>
			<div>
				<span><img src='<%=evcp%>/board/images/admin/ic_triangle.gif' style='margin:0px 5px 0px 0px;' align=absmiddle> 그룹을 배속시킬 등급을 선택하십시오.</span>
				<table id="grid-table" cellpadding="0" cellspacing="0" summary="게시판" class="table_board">
					<colgroup>
						<col width="140px" />
						<col width="*" />
			...
			<h3><a href="#">등급별 사용자 배속</a></h3>
			<div>
				<span><img src='<%=evcp%>/board/images/admin/ic_triangle.gif' style='margin:0px 5px 0px 0px;' align=absmiddle> 사용자를 배속시킬 등급을 선택하십시오.</span>
				<table id="grid-table" cellpadding="0" cellspacing="0" summary="게시판" class="table_board">
					<colgroup>
						<col width="140px" />
						<col width="*" />
...
<c:if test="${aaForm.view == 'existList'}">
	<c:if test="${aaForm.act == 'role'}">
		<form id="gradeRoleMngForm" name="gradeRoleMngForm" onsubmit="return false">
			<table id="grid-table" cellpadding="0" cellspacing="0" summary="게시판" class="table_board">
				...
				<thead>
					<th class="first"><span class="table_title">선택</span></th>
					<th><span class="table_title">역할ID</span></th>
					<th><span class="table_title">역할명</span></th>
				</thead>
				<tbody>
	...
	<form id="gradeGroupMngForm" name="gradeGroupMngForm" onsubmit="return false">
		<table id="grid-table" cellpadding="0" cellspacing="0" summary="게시판" class="table_board">
			...
			<thead>
				<th class="first"><span class="table_title">선택</span></th>
				<th><span class="table_title">그룹ID</span></th>
				<th><span class="table_title">그룹명</span></th>
			</thead>
			<tbody>
	...
	<c:if test="${aaForm.act == 'user'}">
		<form id="gradeUserMngForm" name="gradeUserMngForm" onsubmit="return false">
			<table id="grid-table" cellpadding="0" cellspacing="0" summary="게시판" class="table_board">
				...
				<thead>
					<th class="first"><span class="table_title">선택</span></th>
					<th><span class="table_title">사용자ID</span></th>
					<th><span class="table_title">사용자명</span></th>
				</thead>
				<tbody>
		...
		<table id="grid-table" cellpadding="0" cellspacing="0" summary="게시판" class="table_board">
			...
			<thead>
				<tr>
					...
					<th ch="0"><span class="table_title">역할ID</span></th>
					<th ch="0"><span class="table_title">역할명</span></th>
				</tr>
			</thead>
			<tbody>
				<c:forEach items="${roleList}" var="role" varStatus="status">
		...
		<table id="grid-table" cellpadding="0" cellspacing="0" summary="게시판" class="table_board">
			...
			<thead>
				<tr>
					...
					<th ch="0"><span class="table_title">그룹ID</span></th>
					<th ch="0"><span class="table_title">그룹명</span></th>
				</tr>
			</thead>
			<tbody>
				<c:forEach items="${groupList}" var="group" varStatus="status">
		...
		<table id="grid-table" cellpadding="0" cellspacing="0" summary="게시판" class="table_board">
			...
			<thead>
				<tr>
					...
					<th ch="0"><span class="table_title">사용자ID</span></th>
					<th ch="0"><span class="table_title">사용자명</span></th>
				</tr>
			</thead>
			<tbody>
				<c:forEach items="${userList}" var="user" varStatus="status">
...
AdmGradeMngr.prototype = {
	...
	init : function() {
		$("#authAccordion").accordion({
			autoHeight: false,
			active: 1, // 'change' Event 를 발생시키기 위해 생성 시 두번째 아코디언을 선택.
