...
<div id="content_body">
 ...
 --%>
		...
		<div class="btn_wrap">
			<div class="box_left">
				<a href="javascript:void(0);" onclick="javascript:ebEdit.list();" class="btn btn_basic">목록</a>
			</div>
			<div class="box_right">
				<a href="javascript:void(0);" onclick="javascript:fn_save();" class="btn btn_point">저장</a>
			</div>
		</div>
	</div>
</div>
