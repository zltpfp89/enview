	...
	<script>
		...
		function callBackSelectBankListSuccess(data){
			...
			var QCELLProp = {
				...
				"selectmode": "row",
				"columns" : [ 
                	{ width : '205px' , key : 'receiver',	title : ['수신처'],	sort:true, move:true, resize: true, styleclassname: {data: 'aligncenter fontsize13'}},
		...
		function fn_selectBank(){
			...
			if(selectedBank == null){
				...
				bank = {
					...
					finesMembNo : selectedBank.finesMembNo,
					branchNm : selectedBank.receiver,
					sendFaxNo : selectedBank.sendFaxNo
				} 
