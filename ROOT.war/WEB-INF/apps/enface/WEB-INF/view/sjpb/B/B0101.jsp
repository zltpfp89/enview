...
<!-- 				   </div> -->
<!-- 			   </li> -->
			   <li><span class="title">접수번호</span>
				   <label for="rcptOrdNumSc"></label><input type="text" class="w65per" id="rcptOrdNumSc" name="rcptOrdNumSc"/>
			   </li>
			   ...
			   <li>
			   	<div id="dataDivLi">
			   	    <span class="title">
			   	    	<div class="inputbox w15per" style="background:#f0f0f0;border:none;">
						   <p class="txt"></p>
						   <select id="dateDivSc" name="dateDivSc">
						   		<option value="C">착수일</option>
						   		<option value="T">수리일</option>
						   		
						   </select>
					   </div>
			   	    </span>
				    <label for="srchStartDateSc"></label><input type="text" class="w20per calendar datepicker" id="srchStartDateSc" name="srchStartDateSc" data-type="date" data-optional-value=true title="시작일" readonly="readonly" />
				     ~ <label for="srchEndDateSc"></label><input type="text" class="w20per calendar datepicker" id="srchEndDateSc" name="srchEndDateSc" data-type="date" data-optional-value=true title="종료일" readonly="readonly" />&nbsp;<a href="javascript:initDatePicker();" style="text-align: center;margin: 1px 0 0 5px;box-sizing: border-box;background-color: #ffffff;padding: 0 20px 0 20px;border: 1px solid #d1d2d3;">초기화</a>
			    </div>
			    </li>
...
<!-- 			   </li> -->
			...
			<div class="searchbtn">
				<a href="javascript:void(0);" id="exceldownIncPrnBtn" class="btn_light_green_line excel" style="display:none;"><span>엑셀</span></a>
	   ...
	   <div class="btnArea">
		   <div class="r_btn">	
				<a href="javascript:susaPrnBtnClick();" id="susaPrnBtn" class="btn_white print"><span>수사사건부</span></a>
				<a href="javascript:incPrnBtnClick();" id="incPrnBtn" class="btn_white print"><span>범죄사건부</span></a>
		   		<a href="javascript:insertIncMastView();" id="insertIncMastViewBtn" class="btn_light_blue enrollment"><span>사건등록</span></a>
<!-- 		   		<a href="javascript:unCombIncMastChkBox();" id="unCombIncMastBtn" class="btn_white"><span>사건분리</span></a> -->
<!-- 		   		<a href="javascript:combIncMast();" id="combIncMastBtn" class="btn_light_blue"><span>사건병합</span></a> -->
		   	</div>
		   <div class="l_btn"><a href="javascript:void(0);" id="toggleCriBtn" class="btn_white folding"><span>리스트 접기</span></a></div>
	   </div>
	   <!-- btnArea //-->
		   ...
		   <ul>
					...
					<div class="tab_mini_contents" id="tab_mini_m6_contents">
                    	...
                    	<div id="step_tab">
	                        <ul class="step_tab ocrt_tab clearfix">
	                            ...
	                            <li class="ocrt_sub_tab" id="ocrt_list_tab3" data-href="selectIncJdtRstDetails();sjpbFile.init();"><span class="on"><a href="javascript:void(0);" data-always="y">법원판결 <br/><em id="ocrt_list_tab3_em" class="situation">완료</em></a></span><em class="step_txt">판결</em></li>
	                        </ul>
                        	<br/><br/>
                       		 <!--//ocrt_wrap-->
                        	<div class="ocrt_wrap clearfix">
	                            <!--지휘부관리-->
	                            <div class="ocrt_01 ocrt_list_tab0 list" id="ocrt_list_tab0_div"></div>                        
                           
                            	<!--사건송치부관리-->
                            	<div class="ocrt_01 ocrt_list_tab1 list none" id="ocrt_list_tab1_div"></div>
                           
                            	<!--사건처분관리-->
                            	<div class="ocrt_01 ocrt_list_tab2 list none" id="ocrt_list_tab2_div"></div>
                           
                            	<!--사건판결관리-->
                           		<div class="ocrt_01 ocrt_list_tab3 list none" id="ocrt_list_tab3_div"></div>
			...
			<li class="m4" style="display:none;"><a href="javascript:selectDocMngList();" id="docMngTab" class="tabtitle"><span>수사대장</span></a>
				<div class="tab_mini_contents" id="tab_mini_m4_contents">
	               ...
	               <iframe id="docMngframe" src="" frameborder="0" width="100%" scrolling="no" onload="javascript:parent.iframe_heightResize(this);">
			...
			<li class="m5" style="display:none;"><a href="javascript:abc();" class="tabtitle" data-always="y"><span>통계원표</span></a>
						...
						<ul>
							<li class="m1" id="tab_small_m1_contents_li"><a href="javascript:void(0);" id="occrStsGrapLink" class="tab_small_title" data-always="y"><span>발생통계원표</span></a>
								<div class="tab_small_contents">
									...
									<div class="btnArea" data-name="occrArea01">
										<div class="r_btn">
											<a href="javascript:insertOccrStsGrap();" class="btn_light_blue save"><span>저 장</span></a>
										</div>
									</div>
									
									<div class="btnArea" data-name="occrArea02" style="display:none">
										<div class="r_btn">
											<a href="javascript:updateOccrStsGrap();" class="btn_light_blue save"><span>저 장</span></a>
											<a href="javascript:void(0);" class="btn_white print" id="occrPrnBtn" data-always="y"><span>인쇄</span></a>
										</div>
									</div>
							...
							<li class="m2"><a href="javascript:void(0);" id="arstStsGrapLink" class="tab_small_title" data-always="y"><span>검거통계원표</span></a>
								<div class="tab_small_contents">
									...
									<div class="btnArea" data-name="occrArea01">
										<div class="r_btn">
											<a href="javascript:insertArstStsGrap();" class="btn_light_blue save"><span>저 장</span></a>
										</div>
									</div>
									
									<div class="btnArea" data-name="occrArea02" style="display:none">
										<div class="r_btn">
											<a href="javascript:updateArstStsGrap();" class="btn_light_blue save"><span>저 장</span></a>
											<a href="javascript:void(0);" class="btn_white print" id="arstPrnBtn" data-always="y"><span>인쇄</span></a>
										</div>
									</div>
							...
							<li class="m3"><a href="javascript:void(0);" id="spStsGrapLink" class="tab_small_title" data-always="y"><span>피의자통계원표</span></a>
								<div class="tab_small_contents">
									...
									<div class="btnArea" data-name="occrArea01">
										<div class="r_btn">
											<a href="javascript:insertSpStsGrap();" class="btn_light_blue save"><span>저 장</span></a>
										</div>
									</div>
									<div class="btnArea" data-name="occrArea02" style="display:none">
										<div class="r_btn">
											<a href="javascript:updateSpStsGrap();" class="btn_light_blue save"><span>저 장</span></a>
											<a href="javascript:void(0);" class="btn_white print" id="spPrnBtn" data-always="y"><span>인쇄</span></a>
										</div>
									</div>
								</div>
							</li>
				...
				<li class="m7" style="display:none;"><a href="javascript:incRecordsTab();" id="incRecordsTab" class="tabtitle" data-always="y"><span>수사기록철</span></a>
					<div class="tab_mini_contents" id="tab_mini_m7_contents">
				   		...
				   		<div class="btnArea">
							<div class="r_btn">
								<a href="javascript:addRecord();" class="btn_light_blue enrollment" id="newRcdBtn"><span>신규</span></a>
								<a href="javascript:removeRecord();" class="btn_white appointed" id="delRcdBtn"><span>삭제</span></a>
								<a href="javascript:void(0);" class="btn_white excel" id="exceldownRcdBtn"><span>엑셀</span></a>
							</div>
						</div>
						<div id="tab_mini_m7_contents_sub"></div>
						<div class="btnArea">
							<div class="r_btn">
								<a href="javascript:saveRecord();" class="btn_light_blue enrollment" id="saveRcdBtn"><span>저장</span></a>
							</div>
						</div>
			   		</div>
			   	</li>
