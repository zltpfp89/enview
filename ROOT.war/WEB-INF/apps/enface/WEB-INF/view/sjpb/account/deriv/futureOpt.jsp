...
<html>
	<head>
        ...
        <script type="text/javascript" src="${cPath}/fss/js/account/deriv/futureOpt.js?r=<%=Math.random()%>"></script>
	</head>
	<body class="iframe">
		<form name="" id="">
 		...
 		<div class="searchArea" id="searchArea">
	   	...
	   	<!-- searchArea //-->
	   	<!-- listArea -->
	   	<div id="sheetFutureOpt" class="listArea area-mousewheel" style="height: 800px; width: 100%">
	   	</div>
	   	<!-- listArea //-->
	   	<!-- btnArea -->
	   	<div class="btnArea">
