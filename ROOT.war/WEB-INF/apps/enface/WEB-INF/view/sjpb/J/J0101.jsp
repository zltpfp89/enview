...
<title>수사현황</title>
<script type="text/javascript" src="${pageContext.request.contextPath}/sjpb/js/J/J0101.js?r=<%=Math.random()%>"></script>
...
<!-- listArea -->
<div id="sheet" class="listArea mrt15 area-mousewheel" style="height: 270px; width: 100%">
</div> 
<!-- //listArea -->
<div class="graph_box">		
<!-- 	<div id="J0101Pie" ></div> -->
