...
<html>
	<head>
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/sjpb/js/A/A0101.js?r=<%=Math.random()%>"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/sjpb/js/A/A0302.js?r=<%=Math.random()%>"></script>
	...
	<body class="popup">
			...
			<input type="hidden" id="incMfNum" name="incMfNum" value="${incMfNum}" />	<!-- 사건수정번호 -->	    
    			...
    			<div class="tab_mini_wrap m1">
    			 ...
    			 <div class="tab_mini_contents" id="a0302ContentsDiv">
                        ...
                        <tbody>
                            <tr>                                                                    
                                ...
                                <td class="L" colspan="3">
                                	<textarea id="mfCont" name="mfCont" data-type="required" readonly title="상세내용" cols="" rows="">${a0101VO.mfCont}</textarea>
                                </td>
                            </tr>
                        </tbody>
                    </table>        			 
    			 	
    			 	<div id="a0302ContentsArea">
    			 		<%-- 그리는영역 --%>
    			 		
    			 		
    			 		<div style="width:49%; float:left;" id="a0302ContentsAreaA">
    			 		
						</div>
						
						<div style="width:49%; float:right;" id="a0302ContentsAreaB">
