...
<html>
	<head>
        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/sjpb/js/A/A0301.js?r=<%=Math.random()%>"></script>
		<style>
	...
	<body class="popup">
			...
			<input type="hidden" id="kindCd" name="kindCd" value="${userInfo.kindCd}" />  <!-- 수사단원구분 01:수사관 02:팀장 03:과장 -->	    
    			...
    			<div class="tab_mini_wrap m1">
    			 ...
    			 <div class="tab_mini_contents" id="a0301ContentsDiv">
