...
<html>
	<head>
        ...
        <script type="text/javascript" src="${cPath}/fss/js/account/deriv/derivDealHist.js?r=<%=Math.random()%>"></script>
	...
	<body class="iframe">
 		...
 		<div class="searchArea" id="searchArea">
		   	<ul>
			   	...
			   	<li><span class="title"><input type="radio" name="dateDiv" id="cnclDay" value="C" checked="checked" /><label for="cnclDay">체결일</label><input type="radio" name="dateDiv" id=tranDay" value="T" /><label for="tranDay">결제일</label></span>
			   	...
			   	<li><span class="title">구분</span>
				   	<div class="inputbox w65per">
					   	...
					   	<select id="srchDiv" name="srchDiv">
				   			...
				   			<option value="2">입출금</option>
				   			<option value="3">입출고</option>
					   	</select>
				   	</div>
			   	</li>
		   	</ul>
	   	...
	   	<!-- searchArea //-->
	   	<!-- listArea -->
	   	<div id="sheetDerivDealHist" class="listArea area-mousewheel" style="height: 800px; width: 100%">
	   	</div>
	   	<!-- listArea //-->
	   	<!-- btnArea -->
	   	<div class="btnArea">
