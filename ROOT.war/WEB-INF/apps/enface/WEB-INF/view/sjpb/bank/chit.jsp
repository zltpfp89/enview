...
<html>
	<head>
        ...
        <script type="text/javascript" src="${cPath}/fss/js/account/bank/chit.js?r=<%=Math.random()%>"></script>
	...
	<body class="iframe">
 		...
 		<div class="searchArea" id="searchArea">
	   	...
	   	<!-- searchArea //-->
	   	<!-- listArea -->
	   	<div id="sheetBankChit" class="listArea area-mousewheel" style="height: 800px; width: 100%">
	   	</div>
	   	<!-- listArea //-->
	   	<!-- btnArea -->
	   	<div class="btnArea">
