...
<html>
	<head>
        ...
        <script type="text/javascript" src="${cPath}/fss/js/account/stock/stockDealHist.js?r=<%=Math.random()%>"></script>
	...
	<body class="iframe">
 		...
 		<div class="searchArea" id="searchArea">
	   	...
	   	<!-- searchArea //-->
	   	<!-- listArea -->
	   	<div id="sheetStockDealHist" class="listArea area-mousewheel" style="height: 800px; width: 100%">
	   	</div>
	   	<!-- listArea //-->
	   	<!-- btnArea -->
	   	<div class="btnArea">
