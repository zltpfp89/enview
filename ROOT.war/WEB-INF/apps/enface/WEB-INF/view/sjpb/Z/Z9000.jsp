...
<%@page import="com.saltware.enface.sjpb.Z.service.ReportVO"%>
...
OOFFile file = oof.addFile("crf.root", "%root%/crf/"+reportVO.getReptNm());

OOFConnectionMemo c = oof.addConnectionMemo("*", reportVO.getXmlData());
