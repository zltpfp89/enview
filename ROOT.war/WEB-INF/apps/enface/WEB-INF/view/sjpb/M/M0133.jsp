...
<title>통신제한조치집행대장</title>
<script type="text/javascript" src="${pageContext.request.contextPath}/sjpb/js/M/M0133.js?r=<%=Math.random()%>"></script>
</head>
<body class="iframe">
   <!-- searchArea -->
   <div class="searchArea" data-view-type="mng">
		<form name="m0133_searchList" id="m0133_searchList" method="post" onkeydown="if(event.keyCode==13) fn_M0133_pageInit()">
			<ul>
			...
			<div class="searchbtn">
				<a href="javascript:fn_M_init('m0133_searchList');" class="btn_white reset"><span>초기화</span></a>
				<a href="javascript:fn_M0133_pageInit();" class="btn_light_blue search_01"><span>검색</span></a>
			</div>
		</form>
   </div>
   <!-- searchArea //-->
	...
	<div class="btnArea">
		<div class="r_btn">
			<a href="javascript:fn_M0133_new();" class="btn_light_blue new2" id="btnNew" data-view-type="inc"><span>신규</span></a>
			<a href="javascript:fn_M0133_prnCheckReport();" class="btn_white print" id="btnPrt" data-view-type="mng"><span>출력</span></a>
		</div>
	</div>
	...
	<div class="tab_mini_wrap m1" id="docTab">                               	
	   	<ul>
			<!-- 통신제한조치집행대장 상세탭 -->
	       	<li class="m1"><a href="javascript:void();" class="tabtitle" id="intiIncTab"><span>통신제한조치집행대장 상세</span></a>
	       		<!-- tab_contents -->
	       		<div class="tab_mini_contents" id="contentsArea">
	       			<form id="M0133" name="M0133">
	       				<input type="hidden" name="rcptNum" id="rcptNum"/>
	       				<input type="hidden" name="incSpNum" id="incSpNum"/>
	       				<input type="hidden" name="cmctRstrExecNum" id="cmctRstrExecNum"/>
							...
							<tbody>
								...
								<tr>
									...
									<td class="L" colspan="3">
										<textarea id="cnsmApprExecComn" name="cnsmApprExecComn" cols="" rows="" disabled="disabled" maxlength="30"></textarea>
									</td>
								</tr>
							</tbody>
						</table>
					...
					<div class="btnArea">
						<div class="r_btn" data-view-type="inc">
							<a href="javascript:fn_M0133_insert();" class="btn_light_blue_save" style="display:none;" id="btnInsert"><span>저장</span></a>
							<a href="javascript:fn_M0133_update();" class="btn_light_blue_line appointed" style="display:none;" id="btnUpdate"><span>수정</span></a>									
						</div>
					</div>
				</div>
			</li>
