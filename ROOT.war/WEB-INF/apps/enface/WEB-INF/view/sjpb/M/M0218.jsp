...
<title>사건 지휘부</title>
<script type="text/javascript" src="${pageContext.request.contextPath}/sjpb/js/M/M0218.js?r=<%=Math.random()%>"></script>
</head>
<body class="iframe">
   <!-- searchArea -->
   ...
   <!-- searchArea //-->
	...
	<div class="tab_mini_wrap m1" id="docTab">                               	
	   	<ul>
			<!-- 사건 지휘부 상세탭 -->
	       	<li class="m1"><a href="javascript:void();" class="tabtitle" id="intiIncTab"><span>사건 지휘부 상세</span></a>
	       		<!-- tab_contents -->
	       		<div class="tab_mini_contents" id="contentsArea">
					<div class="list">
			        	<input type="hidden" id="cmdDocNum" name="cmdDocNum" value="" />
			                ...
			                <colgroup>
				             ...
				             <tbody>
				             	 <tr>
				                	...
				                	<td class="L td_line"><input type="text" id="recvNm" name="recvNm" class="w100per" maxlength="10"/></td>
				                </tr>
				                <tr>
				                	<th class="C th_line">접수일자</th>
				                	<td class="L td_line"><input type="text" id="rcptDate" name="rcptDate" class="w100per calendar datepicker"/></td>	
				                	<th class="C th_line">사건번호</th>
				                	<td class="L td_line"><span name="rcptIncNum" id="rcptIncNum"></span></td>
				                </tr>
				                <tr>
									...
									<td class="L td_line"><span name="spIdNum" id="spIdNum"></span></td>						
								</tr>
				                <tr>
	                                <th class="C th_line">주거</th>
	                                <td class="L td_line"><span name="spAddr" id="spAddr"></span></td>
	                                <th class="C th_line">죄명</th>
	                                <td class="L td_line"><span name="criNm" id="criNm"></span></td>
	                            </tr>
	                            <tr>
	                                <th class="C th_line">건의내용</th>
	                                <td class="L td_line" colspan="3">
	                                    <textarea id="cmdComnt" name="cmdComnt" cols="" rows="" style="height:160px;" maxlength="100"></textarea>
	                                </td>
	                            </tr>    
				             </tbody>
			       		</table>
