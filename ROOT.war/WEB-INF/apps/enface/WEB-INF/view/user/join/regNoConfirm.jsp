	...
	<form id="confirmForm" name="confirmForm" method="post">
		<table id="confirmTable" bgcolor="#CCCCEE" border="1" width="800" height="300">
			...
			<tr align="center">
				...
				주민등록번호 <input type="text" name="user_jumin1" size="6" maxlength="6" onkeyup="isNaNRegNo(this.name), autoTab()"/>-<input type="password" name="user_jumin2" size="7" maxlength="7" onkeyup="isNaNRegNo(this.name)" autocomplete="off"/>
			</th>
			</tr>
			<tr align="center">
