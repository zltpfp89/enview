		...
		<form id="inQuiryForm" method="post">
			...
			<table bordercolor="gray" width="300" border="0" bgcolor="#DDDDDD">
				...
				<tr>
					...
					<td class="commonStyle">&nbsp;<input type="text" name="user_jumin1" maxlength="6" size="7" onkeyup="isNaNRegNo(this.name), autoTab()"/> - <input type="password" name="user_jumin2" maxlength="7" size="8" onkeyup="isNaNRegNo(this.name)" autocomplete="off"/></td>
				</tr>
			</table>
