            ...
            <div class="board_search">
                <fieldset>
                 ...
                 <label for="" class="cursor" id="month_label">
                    <input type="text" id="select_month" name="select_month" class="date-picker w70" readonly value="<c:out value="${param.select_month}" />" maxlength=""/> 
                 </label>
                 ...
                 <label for="" class="cursor" id="calendar_label">
                    <input type="text" id="select_date" name="select_date" readonly  class="w80" value="<c:out value="${param.select_date}" />" maxlength=""/> 
                 </label>
