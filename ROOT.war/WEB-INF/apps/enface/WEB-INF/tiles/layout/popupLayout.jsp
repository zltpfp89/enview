...
<%
	...
	request.setAttribute("MAST_ROLE_YN",  EnviewSSOManager.getUserInfo(request).getHasRole("MAST_role"));  //총 과리자 역활 존재여부 true / false
...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/sjpb/css/popupBoard.css" />
