...
{
%>
                 <span style='cursor: pointer; z-index: 1000;' id='enview-close-<%=fragment.getId()%>' title="close" class="portlet-action-close"><img src="<%=request.getContextPath()%>/decorations/images/close.gif" alt="Close" border="0" /></span>
<% if (detached != null) { %>                               
                 <span style='cursor: pointer; z-index: 1000;' id='enview-detach-<%=fragment.getId()%>' title="attach" class="portlet-action-attach"><img src="<%=request.getContextPath()%>/decorations/images/attach.gif" alt="Attach" border="0" id='enview-detach-img-<%=fragment.getId()%>'/></span>              
<% } else {  %>
                 <span style='cursor: pointer; z-index: 1000;' id='enview-detach-<%=fragment.getId()%>' title="detach" class="portlet-action-detach"><img src="<%=request.getContextPath()%>/decorations/images/detach.gif" alt="Detach" border="0" id='enview-detach-img-<%=fragment.getId()%>'/></span>              
<% } }  } %>
                </div>
              </div>
